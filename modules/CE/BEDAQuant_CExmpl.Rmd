...
## Air Quality
<img src="http://derekogle.com/NCMTH107/modules/CE/zimgs/smog.jpg" alt="Smog" class="img-right">
Researches examined air quality daily in New York from May to September 1973. The recorded the maximum daily temperature (<sup>o</sup>F) and ozone concentration (ppb) for each day. Use the results in the scatterplot below to perform a bivariate EDA.

```{r echo=FALSE, results="hide", fig.height=3.5, fig.width=3.5, fig.show="hold",message=FALSE,warning=FALSE}
...
ggplot(data=airquality,mapping=aes(x=Temp,y=Ozone)) +
  ...
  labs(y="Ozone Concentration (ppb)",x="Daily High Temperature (F)") +
...
r <- corr(Temp~CO2,data=df,use="pairwise.complete.obs")
