...
<p>This follows directly from the middle part of the 68-95-99.7% Rule because 350 g is exactly 2&sigma; below &mu; and 550 g is exactly 2&sigma; above &mu;.</p>
...
<div class="alert alert-warning">
<p> We see that 550 g is exactly 2&sigma; above &mu;. Thus, there is 95% between 350 g (2&sigma; below &mu;) and 550 g, 5% outside of that range, and 2.5% in each tail outside of that range. Thus, 2.5% are greater than 550 g.</p>
...
<div class="alert alert-warning">
<p> We see that 400 g is exactly 1&sigma; below &mu;. Thus, there is 68% between 400 g and 500 g (1&sigma; above &mu;), 32% outside of that range, and 16% in each tail outside of that range. Thus, 16% are less than 400 g.</p>
...
<div class="alert alert-warning">
<p>Referring to the plot in the previous question, we see that 500 g is exactly 1&sigma; above &mu;, there is 68% between 400 g and 500 g, and 16% in each tail outside of that range. Thus, the percentage less than 500 g is the 68% between 400 and 500 g plus the 16% that is less than 400 g; for a total of 84%.</p>
</div>
&nbsp;
