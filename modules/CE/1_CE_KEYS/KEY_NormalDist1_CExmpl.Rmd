...
b + 
  ...
  stat_function(fun=dnorm,args=list(mean=mn,sd=sd),xlim=c(mn-4*sd,mn-2*sd),
                geom="area",fill="red",alpha=0.5,color="black",size=1.1) +
  ggpmisc::geom_text_npc(aes(npcx=0.1,npcy=0.05,label="2.5%"),
                         size=9,color="black") +
  stat_function(fun=dnorm,args=list(mean=mn,sd=sd),xlim=c(mn+2*sd,mn+4*sd),
                geom="area",fill="red",color="black",size=1.1) +
  ggpmisc::geom_text_npc(aes(npcx=0.9,npcy=0.05,label="2.5%"),
                         size=9,color="black")
```
</div>
