...
2. The percentage of wood ducks that weight more than 550 g is 2.5%.
...
b + labs(x="Height (in)") +
  stat_function(fun=dnorm,args=list(mean=mn,sd=sd),xlim=c(mn-2*sd,mn+2*sd),
                geom="area",fill="gray20",color="gray50",size=1.1) +
  ggpmisc::geom_text_npc(aes(npcx=0.5,npcy=0.05,label="95%"),
                         size=11,color="white") +
  stat_function(fun=dnorm,args=list(mean=mn,sd=sd),xlim=c(-Inf,mn-2*sd),
                geom="area",fill="red",alpha=0.5,color="gray50",size=1.1) +
  ggpmisc::geom_text_npc(aes(npcx=0.5,npcy=0.05,label="95%"),
                         size=11,color="white") +
  stat_function(fun=dnorm,args=list(mean=mn,sd=sd),xlim=c(mn+2*sd,+Inf),
                geom="area",fill="red",color="gray50",size=1.1) +
  ggpmisc::geom_text_npc(aes(npcx=0.5,npcy=0.05,label="95%"),
                         size=11,color="white")
