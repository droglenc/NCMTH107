...
<li>x&#772;=`r formatC(mean(d$bodytemp),format="f",digits=2)`</li>
<li>p-value=`r formatC(2*distrib(round(mean(d$bodytemp),2),mean=37,sd=0.41/sqrt(nrow(d))),format="f",digits=8)`</li>
...
2*distrib(36.81,mean=37,sd=0.41/sqrt(130))
```
...
1. x&#772;=`r formatC(mean(d$thorax),format="f",digits=2)` &mu;m.
1. p-value=`r formatC(distrib(round(mean(d$thorax),2),mean=190,sd=14/sqrt(nrow(d)),lower.tail=FALSE),format="f",digits=3)`.
...
R Appendix.
```{r eval=FALSE, prompt=FALSE}
distrib(194.17,mean=190,sd=14/sqrt(18),lower.tail=FALSE)
```
