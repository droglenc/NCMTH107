...
1. The residual for an observed IBI score of 20 and a percent of impervious surface of 30% is 20-`r formatC(predict(lm1,data.frame(imp=30)),format="f",digits=1)`=`r formatC(20-predict(lm1,data.frame(imp=30)),format="f",digits=1)`.
