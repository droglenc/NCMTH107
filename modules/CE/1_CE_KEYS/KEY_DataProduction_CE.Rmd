...
1. The response variable is **"reaction time"** because the amount of time awake affects the reaction time (i.e., the longer one is awake, to a point, they will likely show more dexterity). And dexterity (on the test) does not affect how long the subject was awake.
