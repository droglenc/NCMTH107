...
The students' fecal coliform data was recorded in [FecalColiform.csv](FecalColiform.csv). Use these data and `t.test()` to confirm your calculations from the previous exercise.
