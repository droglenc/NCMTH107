...
For this and all other "hypothesis testing" questions, make sure to provide explicit answers with your work shown for all <a href="../11-steps">11 steps of a hypothesis test</a>.
</div>
...
The students' fecal coliform data was recorded in [FecalColiform.csv](FecalColiform.csv). Use these data and `t.test()` to confirm your calculations for Steps 6, 7, 8, and 11 from the previous exercise.
