...
<div class="alert alert-success">For the next two questions, and all other "hypothesis testing" questions, make sure to provide explicit answers with your work shown for all <a href="../11-steps">11 steps of a hypothesis test</a>.
</div>
...
## Increased Civility in Nation-States?[^ICNS]
...
[^ICNS]: This exercise was modified [from here](http://www.shortell.org/book/chap12.html).
