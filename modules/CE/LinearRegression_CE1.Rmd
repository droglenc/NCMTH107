...
a. write a question that would be a valid prediction, and 
a. write a question that would be an extrapolation.

1. A student recorded the height of suds (mm) in a dishwasher for ten different amounts of soap (g). The resulting best-fit line was Y=-20.2+12.4*X for values of X between 3.5 and 8.0.
