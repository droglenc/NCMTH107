...
legend("topright",c("Monsoon",
       ...
       pch=c(21,NA,NA),lty=c(1,NA,NA),col="gray70",bty="n")
legend("bottomleft",c("Winter",
       ...
       pch=c(24,NA,NA),lty=c(2,NA,NA),col="gray70",bty="n")
```
