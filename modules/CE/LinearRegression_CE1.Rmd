...
1. Write a question that would be a valid prediction.
1. Write a question that would be an extrapolation.
...
## Beach Sand
Geologists examined the relationship between the median diameter (mm) of sand granules and the slope or angle (degrees) for nine ocean beaches. Their primary interest was in determining if the variability in sand granule size could be explained by the angle of the beach. The results of their analysis are shown in the scatterplot below.
...
Use these results to answer the questions below. Show your complete work for all calculations.
...
1. What is the predicted median sand diameter for a beach angle of 15^o^?
1. What is the predicted median sand diameter for a beach angle of 4^o^?
1. What is the residual if the beach angle is 5^o^ and the median sand diameter is 0.2 mm?
...
1. How much would you expect the median sand diameter to change if the beach angle increased by 4^o^?
1. Comment on linearity and homoscedasticity.
...
Use these results to answer the questions below using **only the monsoon results**. Show your complete work for all calculations.

1. In terms of the variables of this problem, what is the equation of the best-fit line?
1. In terms of the variables of this problem, INTERPRET the value of the y-intercept?
1. In terms of the variables of this problem, INTERPRET the value of the slope?
1. What is the predicted mean air temperature if the altitude lapse rate is 4000^o^C/km?
1. What is the residual if the mean air temperature is 0^o^C and the altitude lapse rate is 3500^o^C/km?
1. What is the correlation coefficient between mean air temperature and altitude lapse rate?
1. How much would you expect the mean air temperature to change if the altitude lapse rate increased by 1000^o^C/km?
1. What is the predicted mean air temperature if the altitude lapse rate is 1000^o^C/km?
