...
1. I would expect the mean air temperature to decrease by 1000 slopes or `r formatC(-1000*m,format="f",digits=3)` mm, on average, if the altitude lapse rate increased by 10000<sup>o</sup>C/km.
