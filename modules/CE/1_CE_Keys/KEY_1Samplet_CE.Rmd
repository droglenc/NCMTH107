...
<li>One can be 95% confident that the mean CFU per ALL 100 ml of water sampled from this lake on this date is between $168.19-2.064\frac{22.20}{\sqrt{25}}$=`r formatC(ci[1],format="f",digits=0)` and $168.19+2.064\frac{22.20}{\sqrt{25}}$=`r formatC(ci[2],format="f",digits=0)`, which further indicates that the mean CFU is less than 178.</li>
</ol>
