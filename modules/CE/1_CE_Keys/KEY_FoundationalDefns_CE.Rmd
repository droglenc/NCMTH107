...
<p class="bg-warning">In the next two sections of answers please note that the variable type must be one of continuous, discrete, nominal, or ordinal (saying quantitative or categorical is not specific enough).</p>
...
<p class="bg-warning">In the answers that follow please note the following things:</p>
<ul class="bg-warning">
