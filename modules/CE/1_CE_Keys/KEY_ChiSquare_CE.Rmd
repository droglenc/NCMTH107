...
<li>In hand-calculation questions (e.g., AIDS cases) make sure to put `lower.tail=FALSE` in `distrib()` when calculation the p-value (Step 8) in a chi-square problem. This is true for EVERY chi-square problem.</li>
</ul>
</div>
...
<ol>
  <li>&alpha;=0.01.</li>
  <li>H<sub>O</sub>: "The distribution of people in the race categories is the same for male and females" versus H<sub>A</sub>: "The distribution of people in the race categories is NOT the same for male and females."</li>
  <li>A chi-square test is required because a categorical response variable with four levels (race/ethnicity) from two groups or populations (sex) was recorded and the proportions in the response variable are being compared among groups in the null hypothesis.</li>
...
```
  ...
  <li>The table of observed frequencies were given but are also in `r tbls("aids2",display="cite")`.</li>
...
```
  ...
  <li>It appears that the distribution of the individuals into the races/ethnicities differs between the sexes. An analysis of the row percentages table (`r tbls("aids4",display="cite")`) shows that there are many more white male and black females than would be expected.</li>
