...
<p><strong>Note:</strong> The object name to the left of each assignment operator (i.e., `<-`) can largely be whatever you want. In the examples below, I tried to uses names that made sense for the data being imported.</p>
</div>
