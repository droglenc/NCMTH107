...
tbls(name="BlightRaw","Frequency table for the fire-blight data. Note that A=no action (control), B=removal of the affected branches, C=spraying of foliage with an antibiotic and the removal of affected branches, 1=the tree died in the same year that the disease was noticed, 2=the tree died after 2-4 years, 3=the tree died after 4 years.")
tbls(name="BlightRow","Percentages of outcomes within each tree treatment type. Abbreviations are given in Table 1.")
...
```{r echo=FALSE}
d <- data.frame(VAR1 <- c("D","C","A","C","A","D","C","A","D","B",
                          "A","B","B","A","C","D","A","C","A","B",
                          "B","A","D","C","A","C","B","B"),
                VAR2 <- c("c","c","b","c","a","c","a","b","c","b",
                          "c","c","b","c","c","c","c","c","b","b",
                          "a","b","c","b","a","b","a","b"))
```
```{r eval=FALSE}
...
<ol>
  <li>The frequency table is in `r tbls("BlightRaw",display="cite")`.</li>
...
tbl
```
  <li>The row percentage table is shown in `r tbls("BlightRow",display="cite")`.</li>
...
```
  ...
  <li>The column percentage table is shown in `r tbls("BlightCol",display="cite")`.</li>
...
```
  ...
  <li>The table percentage table is shown in `r tbls("BlightTot",display="cite")`.</li>
