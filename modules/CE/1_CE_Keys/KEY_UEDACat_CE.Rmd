...
<li>There is probably no good reason to produce both a table and bar chart, when the data are simple as those shown below. I showed both below to assure that the one that you used could be seen.</li>
</ul>
</div>
