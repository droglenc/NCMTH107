...
<div class="alert alert-warning">
<strong>Note (for all of these EDA questions):</strong> 
<ul>
<li>That all four items (Shape, Outliers, Center, and Dispersion) are addressed for each question. Many students may omit outliers if no outliers exist; however, you should explicity say "no outliers were present" (or similar) as shown below.</li>
