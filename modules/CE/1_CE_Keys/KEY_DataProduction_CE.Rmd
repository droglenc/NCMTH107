...
<div class="alert alert-warning">
<strong>Note:</strong> Make sure to list all of the factors, list levels seperately for each of the factors, and list the number of replicates as the number of individuals PER treatment (not all of the individuals in the experiment).
</div>
...
<div class="alert alert-warning">
<strong>Note:</strong> The response variable is potentially responding to or depending on the explanatory variable. The response variable is potentially affected by the explanatory variable.
</div>
