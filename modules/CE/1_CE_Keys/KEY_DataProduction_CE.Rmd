...
<strong>Note:</strong> The key distinction is to determine if a treatment was imparted by the researcher or not. If it was, then it is an experiment.
</div>
...
<div class="alert alert-warning">
<strong>Note:</strong> The response variable is potentially responding to, depending on, or affected by the explanatory variable.
</div>
...
<div class="alert alert-warning">
<strong>Note:</strong> Here and in the next question, make sure to list all of the factors, list levels seperately for each of the factors, and list the number of replicates as the number of individuals PER treatment (not all of the individuals in the experiment). For the R work you don't need to use the code with the square brackets, just split the random numbers up into as many groups as you have treatments.
</div>
...
<div class="alert alert-warning">
<strong>Note:</strong> The randomization in this example is fairly non-typical and is completely dependent on the way the researchers set up this experiment. In other words, focus on the previous examples for a more general method of randomizing individuals for the treatments.
</div>
