...
1. **Applications**
    1. [Avocado Sales](#avocado-sales)
    1. [Penguin Size](#penguin-size)
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.width=7, fig.height=3.1}
d <- read.csv("https://raw.githubusercontent.com/allisonhorst/palmerpenguins/master/inst/extdata/penguins.csv")
...
Use the results for **GENTOO** penguins to answer the questions below.
