...
```{r FLPThrush, echo=FALSE, fig.width=3.5,fig.height=3.5}
...
ggplot(data=molt1,mapping=aes(x=date,y=duration)) +
  ...
  stat_SLR_equation(aes(label=..eq.label..),
                    label.x.npc=0.6,cf.digits=c(1,3)) +
  stat_SLR_equation(aes(label=..rr.label..),label.x.npc=0.6,label.y.npc=0.9) +
...
```{r FLPAgeSBP, echo=FALSE, fig.width=3.5,fig.height=3.5}
...
```{r FLPTV, echo=FALSE, fig.width=3.5,fig.height=3.5}
...
ggplot(data=tv,mapping=aes(x=rating,y=audience)) +
  ...
  stat_SLR_equation(aes(label=..eq.label..),cf.digits=c(0,1),
                    label.x.npc=0.7,label.y.npc=0.15) +
  stat_SLR_equation(aes(label=..rr.label..),label.x.npc=0.7,label.y.npc=0.05) +
...
```{r FLPFawns, echo=FALSE, fig.width=3.5,fig.height=3.5}
