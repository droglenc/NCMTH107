...
figs(name="fires","Bar chart of frequency of forest fires in Montesinho Natural Part from 2000-2003.")
...
[Cortex and Morais (2007)](http://www3.dsi.uminho.pt/pcortez/fires.pdf) describe attributes of forest fires in Montesinho Natural Park in Portugal. The number of forest fires by month from 2000-2003 are displayed in `r figs("fires",display="cite")`

```{r ffBar, echo=FALSE, fig.width=4, fig.height=4}
...
## Fate of Plastics
<img src="zimgs/plastic_bales.jpg" alt="Plastic Bales" class="img-right">
