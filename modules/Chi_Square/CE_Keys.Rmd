...
setwd("C:/aaaWork/Web/GitHub/NCMTH107/modules/ChiSquare/")
...
<li>Chi-square test because (i) two or more populations (grades) were sampled and (ii) the response variable (goals category) is categorial.</li>
...
<li>All cells in the expected frequency table (`r tbls("PopTable",display="cite")`) were greater than 5; the assumptions for a chi-square test have been met.</li>
...
<li>The observed frequency table is shown in `r tbls("PopTable",display="cite")`.</li>
