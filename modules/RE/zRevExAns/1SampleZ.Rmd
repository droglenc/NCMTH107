...
1. A one-sample Z-test is required because (i) a quantitative variable (growth) was measured, (ii) individuals from only one group/population were sampled (only one set of conditions considered), (iii) the population mean is compared to a specific value in the null hypothesis, and (iv) $\sigma$ is known (given in the background).
