...
1. The p-value is `r kPvalue(distrib(3.26,mean=4,sd=1.40/sqrt(10)),include.p=FALSE,latex=FALSE)`.
...
1. A 95% upper confidence bound is warranted in this situation and will use a Z<sup>&lowast;</sup> = `r formatC(distrib(0.95,type="q"),format="f",digits=3)`. Thus, 3.26+1.645*0.44 or 3.26+0.72 = 3.98. Thus, one is 95% confident that the mean growth of all cacti under the experimental conditions is less than 3.98 cm.
