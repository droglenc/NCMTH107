...
1. &alpha; = 0.05.
1. H<sub>0</sub>: &mu; = 4, H<sub>A</sub>: &mu; < 4 where &mu; is the mean growth of all cacti.
...
1. A 95% upper confidence bound is warranted in this situation and will use a Z<sup>&lowast;</sup> = `r formatC(distrib(0.95,type="q",plot=FALSE),format="f",digits=3)`. Thus, 3.26+1.645*0.44 or 3.26+0.72 = 3.98. Thus, one is 95% confident that the mean growth of all cacti under the experimental conditions is less than 3.98 cm.
...
1. H<sub>0</sub>: &mu; = 600, H<sub>A</sub>: &mu; &neq; 600 where &mu; is the mean length of all pike in Chivyrkui Bay, Lake Baikal.
...
1. &alpha; = 0.10.
1. H<sub>0</sub>: &mu; = 190, H<sub>A</sub>: &mu; &neq; 190 where &mu; is the mean cholesterol level of Asian women.
