...
## Mac
To install R on a Mac, downloaded the installer from [this site](https://cloud.r-project.org/bin/macosx/) by selecting one of the “R-X.X.X.pkg” links appropriate for your operating system under the “Latest Release” section. Locate the “.pkg” file on your computer and install it per usual. Using all of the default choices will perform an acceptable install for this class.1
...
Once you have created your account, follow [this link to the “MTH107” project](https://rstudio.cloud/project/1331782), which should open a project that looks like that below. Currently this project is in my “workspace.” Click on the red “Save a Permanent Copy” item in the top bar to save the project to your workspace (see below). When you return in the future this project will appear in the left-hand menu, open it to begin your work.

```{r echo=FALSE, layout="l-body-outset"}
knitr::include_graphics("zimg/RCloud.jpg")
```
