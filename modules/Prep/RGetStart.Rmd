...
Note that the free version of RStudio Cloud is limited to 25 hours of work per month. In past semesters this has been adequate for our work up to the modules under the "Using R" subsection (see [modules list](../)). Once we start the "Using R" portion of the modules you will likely need to upgrade to the "Cloud Plus" account which is currently $5/month for 75 hours of project time. Thus, the free account should be adequate for about the first 2/3rds or so of the semester, so don't sign up for the "Plus" account until later in term. 

Once you have created your account, follow [this link to the “MTH107” project](https://rstudio.cloud/project/2239963), which should open a project that looks close to that below. Currently this project is in my “workspace.” Click on the red “Save a Permanent Copy” item in the top bar to save the project to your workspace (see below). When you return to "RStudio in the Cloud" in the future this project will appear in the left-hand menu, open it to begin your work.
