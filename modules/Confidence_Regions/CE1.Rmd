...
1. Compute the margin-of-error "by hand" for the 99% confidence and n=10 situation to determine if that computed by `ciSim()` is correct. Note that `ciSim()` assumes that &sigma;=10.
