...
Base R uses a function called `subset()` to construct subsets of a data.frame.  For example, the following code can be used to construct a data.frame fro the `Iris.csv` file that contains a single species.
```{r}
