...
The fourth Quiz (see [dates page](../Dates-Current)) will cover material from Module 19 (*1-Sample t-Test*), Module 20 (*2-Sample t-Test*), and Module 21 (*Chi-Square Test*). The exam consists of three 11-Step hypothesis tests that will require no R work, with the exception of using `distrib()` to calculate p-values and critical values for confidence regions. Hints for using `distrib()`, the [11 Steps of a Hypothesis Test](../../modules/11-steps), and formulae for the test statistics for each hypothesis test will be provided for you on the quiz ([see here for example](Quiz4_InfoGiven.pdf)). The following are links to examples for each of the questions.
