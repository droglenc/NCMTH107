...
### Tutors
Northland College offers free tutoring to aid you in your academic success. Seek a tutor early in the semester so that you can establish a regular meeting schedule, develop your skills, and receive the cumulative and beneficial effects that result from ongoing sessions. Drop-in tutoring for statistics is available on Mon, Tues, Wed, and Sun from 7-8pm in the tutoring center in the basement of the Dexter Library. If you have questions about tutoring or would like one-on-one tutoring please contact [Academic Affairs](mailto:academicaffairs@northland.edu).
