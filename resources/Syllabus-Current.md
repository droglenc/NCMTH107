...
### Tutors
Northland College offers free tutoring to aid you in your academic success. Seek a tutor early in the semester so that you can establish a regular meeting schedule, develop your skills, and receive the cumulative and beneficial effects that result from ongoing sessions. Drop-in tutoring for statistics is available on Mon, Tue, Wed, and Thu from 7-8pm in the tutoring center in the basement of the Dexter Library. If you have questions about tutoring or would like one-on-one tutoring please contact [Academic Affairs](mailto:academicaffairs@northland.edu).
...
Grades on individual module preparation guides and assignments can be found on the class Gradescope page ([quick link on class homepage](../){:target="_blank"}). I will update your percentage grades for the Preparation Guides, Module Assignments, and Engagement on mycourses.northland.edu ([quick link on class homepage](../)) periodically (I will send you a message when I do), which will then show your grade as of that time. You can also compute your overall grade at any time by entering your percentage scores in the [table above](#grading) for completed assessments. You can also include percentages for future assessments to project your future grade.
