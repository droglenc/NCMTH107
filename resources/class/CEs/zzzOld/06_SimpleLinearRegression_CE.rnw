...
\item In terms of the variables of this problem, INTERPRET the value of the y-intercept?
\item What is the predicted IBI for an impervious surface percentage of 80\%?
\item What is the predicted IBI for an impervious surface percentage of 20\%?
\item What is the residual if the impervious surface percentage is 30 and the IBI is 20?
\item What is the correlation coefficient between IBI and the percentage of impervious surface?
\item What proportion of the variability in IBI is explained by knowing the percentage of impervious surface?
