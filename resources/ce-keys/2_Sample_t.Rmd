...
<li>I am 90% confident that the true difference in population means is greater than `r formatC(lcb,format="f",digits=1)`.  More specifically, I am 90% confident that the true mean for the first group is <i>at least</i> `r formatC(lcb,format="f",digits=1)` greater than the true mean for the second group.</li>
</ol>
