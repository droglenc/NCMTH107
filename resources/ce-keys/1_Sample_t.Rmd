...
<li>Strictly not needed, but one could say that they were 95% confident that the number of killings in recent years for ALL nation-states is less than `r formatC(ucb,format="f",digits=0)` (which contains the value in the $H_{0}$).</li>
</ol>
