...
<li>I am 95% confident that the true population mean equatorial radius of Jupiter is between `r formatC(71492-zstar*28/sqrt(40),format="f",digits=0)` and `r formatC(71492+zstar*28/sqrt(40),format="f",digits=0)` km.</li>
</ol>
