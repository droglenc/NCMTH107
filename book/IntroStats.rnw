...
eng <- "c:/apps/sejda-console/bin/sejda-console splitbybookmarks"
# set input filename
inp <- paste0("-f ",dir,fn,".pdf")
# sets bookmark level to split at
ins <- "-l 1 --discardOutline"
# set output directory and prefish for filenames to the name of the bookmark
...
##   intermediate files from the directory ... just looks cleaner
tmp <- list.files(dir)
