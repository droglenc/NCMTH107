...
@
<<child-BivEDAQuant, child='BivEDAQuant.Rnw', eval=FALSE>>=
@
...
<<child-RUnivSum, child='RUnivSum.Rnw', eval=FALSE>>=
@

<<child-GettingDataIntoR, child='GettingDataIntoR.Rnw', eval=FALSE>>=
@
<<child-FilteringDataInR, child='FilteringDataInR.Rnw', eval=FALSE>>=
@
