...
\caption[Examples of symmetric (left), left-skewed (center), and right-skewed (right) distributions]{Examples of symmetric (left), left-skewed (center), and right-skewed (right) distributions.}\label{fig:ShapeExamples1}
\end{figure}
