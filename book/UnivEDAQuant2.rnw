...
<<ShapeExamples1, echo=FALSE, fig.width=3*2.75, fig.height=2.75, out.width='.9\\linewidth', fig.cap="Examples of left-skewed (center), symmetric (left), and right-skewed (right) distributions.">>=
x <- seq(0,1,0.005)
