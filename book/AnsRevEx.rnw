...
@
  ...
  \item \hypertarget{ans:BasicsDataFrame1}{\ref{revex:BasicsDataFrame1}} --
    \begin{enumerate}
      \item
<<>>=
df <- read.table("data/DougFirBiometrics.txt",header=TRUE)
@
      \item
<<>>=
str(df)
...
@
      \item
<<>>=
dfIngrid <- Subset(df,observer=="Ingrid")
dfIngrid
@
      \item
<<>>=
dfDylan <- Subset(df,observer=="Dylan")
dfDylan$height
@
      \item
<<>>=
dfLT10 <- Subset(df,height<10)
dfLT10
@
      \item
<<>>=
df2 <- Subset(df,height>10 & circ<1)
df2
@
    \end{enumerate}
\end{itemize}
...
@
<<HistCP, fig.width=3.5, fig.height=3.5, par1=TRUE>>=
...
@
<<HistAirPolln, fig.width=3.5, fig.height=3.5, par1=TRUE>>=
...
<<echo=FALSE>>=
hts <- c(1.56,1.54,1.54,1.57,1.58,1.61,1.60,1.69,1.99,2.11,1.98,1.76,1.69,1.99,1.86,1.53)
brule <- data.frame(hts)
bruleSum <- Summarize(~hts,data=brule)
brule$shts <- hts[order(hts)]
brule.mdn <- mean(brule$shts[8:9])
@
  
  \item \hypertarget{ans:quEDABrule}{\ref{revex:quEDABrule}} -- By R, the mean is \Sexpr{formatC(bruleSum["mean"],format="f",digits=2)} and median is \Sexpr{formatC(bruleSum["median"],format="f",digits=2)}.
<<eval=FALSE>>=
...
wi <- data.frame(dens)
wiSum <- Summarize(~dens,data=wi)
wi$sdens <- dens[order(dens)]
wiSum.mdn <- wi$sdens[8]
@

  \item \hypertarget{ans:quEDAWIC}{\ref{revex:quEDAWIc}} -- The mean is \Sexpr{formatC(wiSum["mean"],format="f",digits=1)} and median is \Sexpr{formatC(wiSum["median"],format="f",digits=1)}.
<<eval=FALSE>>=
...
<<echo=FALSE>>=
creatSum <- Summarize(~cp,data=creat)
creat$scp <- creat$cp[order(creat$cp)]
creat.mdn <- mean(creat$scp[18:19])
@
  \item \hypertarget{ans:quEDACreatPhosph2}{\ref{revex:quEDACreatPhosph2}} -- The mean is \Sexpr{formatC(creatSum["mean"],format="f",digits=1)} and median is \Sexpr{formatC(creatSum["median"],format="f",digits=1)}. 
<<>>=
...
<<echo=FALSE>>=
apSum <- Summarize(~polln,data=ap)
ap$spolln <- ap$polln[order(ap$polln)]
ap.mdn <- ap$spolln[16]
@  
\noindent By hand, the mean and the median are the same as with R. 
  \item \hypertarget{ans:quEDAAirPolln2}{\ref{revex:quEDAAirPolln2}} -- The mean is \Sexpr{formatC(apSum["mean"],format="f",digits=1)} and median is \Sexpr{formatC(apSum["median"],format="f",digits=1)}.
<<>>=
...
@
  ...
  \item \hypertarget{ans:quEDABruleDisp}{\ref{revex:quEDABruleDisp}} -- The range is \Sexpr{formatC(bruleSum["min"],format="f",digits=2)} to \Sexpr{formatC(bruleSum["max"],format="f",digits=2)}, the IQR is \Sexpr{formatC(bruleSum["Q1"],format="f",digits=2)} to \Sexpr{formatC(bruleSum["Q3"],format="f",digits=2)}, and a standard deviation of \Sexpr{formatC(bruleSum["sd"],format="f",digits=2)}.
<<>>=
Summarize(~hts,data=brule,digits=2)
@
<<echo=FALSE>>=
brule.Q1 <- mean(brule$shts[4:5])
brule.Q3 <- mean(brule$shts[11:11])
@
\noindent By hand, the range and standard deviation are the same, but the IQR is \Sexpr{formatC(brule.Q1,format="f",digits=2)} to \Sexpr{formatC(brule.Q3,format="f",digits=2)}.

  \item \hypertarget{ans:quEDAWIDisp}{\ref{revex:quEDAWIDisp}} -- The range is \Sexpr{formatC(wiSum["min"],format="f",digits=1)} to \Sexpr{formatC(wiSum["max"],format="f",digits=1)}, the IQR is \Sexpr{formatC(wiSum["Q1"],format="f",digits=1)} to \Sexpr{formatC(wiSum["Q3"],format="f",digits=1)}, and a standard deviation of \Sexpr{formatC(wiSum["sd"],format="f",digits=1)}.
<<>>=
Summarize(~dens,data=wi,digits=1)
@
<<echo=FALSE>>=
wiSum.Q1 <- mean(wi$sdens[4])
wiSum.Q3 <- mean(wi$sdens[12])
@
\noindent By hand, the range and standard deviation are the same, but the IQR is \Sexpr{formatC(wiSum.Q1,format="f",digits=1)} to \Sexpr{formatC(wiSum.Q3,format="f",digits=1)}.
 
  \item \hypertarget{ans:quEDACreatPhosph3}{\ref{revex:quEDACreatPhosph3}} -- The range is \Sexpr{formatC(creatSum["min"],format="f",digits=1)} to \Sexpr{formatC(creatSum["max"],format="f",digits=1)}, the IQR is \Sexpr{formatC(creatSum["Q1"],format="f",digits=1)} to \Sexpr{formatC(creatSum["Q3"],format="f",digits=1)}, and a standard deviation of \Sexpr{formatC(creatSum["sd"],format="f",digits=1)}.
<<>>=
Summarize(~cp,data=creat,digits=1)
@  
<<echo=FALSE>>=
creat.Q1 <- mean(creat$scp[9:10])
creat.Q3 <- mean(creat$scp[27:28])
@
\noindent By hand, the range and standard deviation are the same, but the IQR is \Sexpr{formatC(creat.Q1,format="f",digits=1)} to \Sexpr{formatC(creat.Q3,format="f",digits=1)}.

  \item \hypertarget{ans:quEDAAirPolln3}{\ref{revex:quEDAAirPolln3}} -- The range is \Sexpr{formatC(apSum["min"],format="f",digits=1)} to \Sexpr{formatC(apSum["max"],format="f",digits=1)}, the IQR is \Sexpr{formatC(apSum["Q1"],format="f",digits=1)} to \Sexpr{formatC(apSum["Q3"],format="f",digits=1)}, and a standard deviation of \Sexpr{formatC(apSum["sd"],format="f",digits=1)}.
<<>>=
Summarize(~polln,data=ap,digits=1)
@
<<echo=FALSE>>=
ap.Q1 <- mean(ap$spolln[8])
ap.Q3 <- mean(ap$spolln[24])
@
\noindent By hand, the range and standard deviation are the same, but the IQR is \Sexpr{formatC(ap.Q1,format="f",digits=1)} to \Sexpr{formatC(ap.Q3,format="f",digits=1)}.
...
<<BoxplotWIc, fig.width=3.5, fig.height=3.5, par1=TRUE>>=
...
@
<<echo=FALSE>>=
awSum <- Summarize(~arswater,data=ars)
@
    \begin{enumerate}
      \item The distribution of arsenic in the well water is very strongly right-skewed with an outlier at \Sexpr{formatC(awSum["max"],format="f",digits=4)} ppm.  The center as measured by the median is \Sexpr{formatC(awSum["median"],format="f",digits=4)} and the IQR is from a Q1 of \Sexpr{formatC(awSum["Q1"],format="f",digits=4)} to a Q3 of \Sexpr{formatC(awSum["Q3"],format="f",digits=4)}.  The median and IQR were used because of the highly skewed distribution and the presence of an outlier.
<<ArsHist1, fig.width=3.5, fig.height=3.5, par1=TRUE>>=
Summarize(~arswater,data=ars,digits=4)
hist(~arswater,data=ars,xlab="Arsenic in Well-Water",ylab="Frequency",main="")
@

<<echo=FALSE, results='hide'>>=
atSum <- Summarize(~arsnails,data=ars)
@
      \item The distribution of arsenic in the toe nails is very strongly right-skewed with an outlier at \Sexpr{formatC(atSum["max"],format="f",digits=4)} ppm.  The center as measured by the median is \Sexpr{formatC(atSum["median"],format="f",digits=4)} and the IQR is from a Q1 of \Sexpr{formatC(atSum["Q1"],format="f",digits=4)} to a Q3 of \Sexpr{formatC(atSum["Q3"],format="f",digits=4)}.  The median and IQR were used because of the highly skewed distribution and the presence of an outlier.
<<ArsHist2, fig.width=3.5, fig.height=3.5, par1=TRUE>>=
...
<<ArsBox1, fig.width=3.5, fig.height=3.5, par1=TRUE>>=
...
<<ArsBar1, fig.width=3.5, fig.height=3.5, par1=TRUE>>=
...
<<echo=FALSE>>=
recycle <- factor(c("C","C","B","B","B","B","C","E","B","B","C","B","C","B","C","C",
"C","E","B","B","B","C","B","B","C","C","C","B","C","B","C","B","B","C","B","C",
"B","B","B","C","E","B","E","B","B","C","C","B","B","B","E","B","C","C","C","B",
"B","C","B","B","B","B","B"))
...
<<echo=FALSE>>=
water <- factor(c("D","C","B","B","C","C","B","B","C","C","C","B","D","B","C","C",
"B","C","D","D","B","C","C","A","B","C","C","A","C","C","D","A","C","C","B","B",
"B","B","B","C","D","B","D","B","C","B","C","C","D","C","B","B","D","C","B","C",
"B","B","C","C","B","C","B","C","B","B","C","D","B","C","D","C","B","C","D","C",
"C","B","C","B","D","B","B","D","B","C","B","B","C","B","C","D","D","C","D","B",
"B","C","B","C","A","A","B","C","B","C","D","D","C","B","D","C","C","C","C","A",
"C","D","B","C","B","B","D","C","B","B","A","B","C","B"))
rice <- data.frame(water)
@
<<eval=FALSE>>=
...
<<echo=FALSE>>=
pl <- c(13, 2, 1, 0, 9, 11, 5, 5, 14, 23, 0, 2, 3, 3, 6, 7, 4, 16, 1)
gg <- data.frame(pl)
ggSum <- Summarize(~pl,data=gg)
@
  \item \hypertarget{ans:quEDAPL}{\ref{revex:quEDAPL}} --  The distribution of the number of purple loosestrife plants per plot is strongly right-skewed \figrefp{fig:PLHist}.  There does not appear to be any outliers.  The median is \Sexpr{formatC(ggSum["median"],format="f",digits=1)} plants and the IQR is from \Sexpr{formatC(ggSum["Q1"],format="f",digits=1)} to \Sexpr{formatC(ggSum["Q3"],format="f",digits=1)} plants \tabrefp{tab:PLSum}.  I chose to use the median and IQR as measures of center and dispersion because of the strongly skewed shape.
<<eval=FALSE>>=
gg <- read.table("data/GreenGables.txt",header=TRUE)
@
<<PLHist, fig.width=3.5, fig.height=3.5, fig.cap="Histogram of number of purple loosestrife plants in Green Gables Slough.", par1=TRUE>>=
hist(~pl,data=gg,xlab="Number of Plants",main="")
@
<<eval=FALSE>>=
Summarize(~pl,data=gg,digits=2)
@
<<PLStats, results='asis', echo=FALSE>>=
plstat <- Summarize(~pl,data=gg,digits=2)
plstat1 <- matrix(plstat,nrow=1)
colnames(plstat1) <- names(plstat)
print(xtable(plstat1,digits=2,caption="Descriptive statistics of number of purple loosestrife plants in Green Gables Slough.","tab:PLSum"),caption.placement="top",include.rownames=FALSE)
@

  \item \hypertarget{ans:quEDACP}{\ref{revex:quEDACP}} --   The creatine phosphokinase data appears to be right-skewed with two possible outliers having concentrations near 200 u/l \figrefp{fig:CPHist}.  In addition, the center of the distribution is best measured by the median which is \Sexpr{formatC(creatSum["median"],format="f",digits=2)} u/l \tabrefp{tab:CPSum}.  Finally, the dispersion of the middle 50\% of individuals (i.e., the IQR) is from Q1=\Sexpr{formatC(creatSum["Q1"],format="f",digits=2)} to Q3=\Sexpr{formatC(creatSum["Q3"],format="f",digits=2)} u/l.  I chose to use the median and IQR because the data were not symmetric and outliers were present.
<<CPHist, fig.width=3.5, fig.height=3.5, fig.cap="Histogram of creatine phosphokinase values in 36 male volunteers.", par1=TRUE>>=
hist(~cp,data=creat,breaks=seq(20,220,20),xlab="Creatine Phosphate (Iu/L)",main="")
@
<<eval=FALSE>>=
Summarize(~cp,data=creat,digits=2)
@
<<CPStats, results='asis', echo=FALSE>>=
cpstat <- Summarize(~cp,data=creat,digits=2)
cpstat1 <- matrix(cpstat,nrow=1)
colnames(cpstat1) <- names(cpstat)
print(xtable(cpstat1,digits=2,caption="Descriptive statistics of creatine phosphokinase values in 36 male volunteers.","tab:CPSum"),caption.placement="top",include.rownames=FALSE)
@


<<echo=FALSE>>=
hcr <- c(152,180,167,119,115,113,119,135,140,126,114,133,205,104,149,124,127,161,106,179)
dj <- data.frame(hcr)
djSum <- Summarize(~hcr,data=dj)
@
  \item \hypertarget{ans:quEDADJTI}{\ref{revex:quEDADJTI}} -- This distribution is clearly right-skewed with no obvious outliers \figrefp{fig:DJHist}.  The median is \Sexpr{formatC(djSum["median"],format="f",digits=2)} with an IQR of \Sexpr{formatC(djSum["Q1"],format="f",digits=2)} to \Sexpr{formatC(djSum["Q3"],format="f",digits=2)} \tabrefp{tab:DJSum}.  I chose to use the median and IQR as measures of center and dispersion because of the skewed shape.
<<eval=FALSE>>=
dj <- read.table("data/DowJones.txt",header=TRUE)
@
<<DJHist, fig.width=3.5, fig.height=3.5, fig.cap="Histogram of the Dow Jones Travel Index for 20 cities.", par1=TRUE>>=
hist(~hcr,data=dj,xlab="Dow Jones Travel Index",main="")
@
<<eval=FALSE>>=
Summarize(~hcr,data=dj,digits=2)
@
<<DJStats, results='asis', echo=FALSE>>=
djstat <- Summarize(~hcr,data=dj,digits=2)
djstat1 <- matrix(djstat,nrow=1)
colnames(djstat1) <- names(djstat)
print(xtable(djstat1,digits=2,caption="Descriptive statistics of the Dow Jones Travel Index for 20 cities.","tab:DJSum"),caption.placement="top",include.rownames=FALSE)
@  
...
dPtbl <- percTable(dTbl,digits=1)
@
<<DJStats2, results='asis', echo=FALSE>>=
dPtbl <- matrix(dPtbl,nrow=1)
colnames(dPtbl) <- c(levels(d$type),"Sum")
print(xtable(dPtbl,digits=1,caption="Percentage of all animals in the three major types.","tab:Zoo1"),caption.placement="top",include.rownames=FALSE)
@  

<<echo=FALSE>>=
d <- read.csv("data/Zoo2.csv",header=TRUE)
dSum <- Summarize(~size,data=d)
@
  \item \hypertarget{ans:quEDAZoo2}{\ref{revex:quEDAZoo2}} -- This distribution of zoo sizes is strongly right-skewed with no obvious outliers \figrefp{fig:ZooHist}.  The median is \Sexpr{formatC(dSum["median"],format="f",digits=2)} with an IQR of \Sexpr{formatC(dSum["Q1"],format="f",digits=2)} to \Sexpr{formatC(dSum["Q3"],format="f",digits=2)} \tabrefp{tab:ZooSum}.  I chose to use the median and IQR as measures of center and dispersion because of the skewed shape.
<<eval=FALSE>>=
d <- read.csv("data/Zoo2.csv",header=TRUE)
@
<<ZooHist, fig.width=3.5, fig.height=3.5, fig.cap="Histogram of the size of 46 American zoos.", par1=TRUE>>=
hist(~size,data=d,xlab="Size (acres)",main="")
@
<<eval=FALSE>>=
Summarize(~size,data=d,digits=2)
@
<<DJStats3, results='asis', echo=FALSE>>=
dStat <- Summarize(~size,data=d,digits=2)
dStat1 <- matrix(dStat,nrow=1)
colnames(dStat1) <- names(dStat)
print(xtable(dStat1,digits=2,caption="Descriptive statistics of the sizes of 46 American zoos.","tab:ZooSum"),caption.placement="top",include.rownames=FALSE)
@  
...
\begin{itemize}  
  ...
  \item \hypertarget{ans:quNormZ0.11}{\ref{revex:quNormZ0.11}} -- \Sexpr{formatC(100*distrib(0.11,plot=FALSE),format="f",digits=1)}\%, as computed with
<<par1a=TRUE>>=
( distrib(0.11,mean=0,sd=1) )
@ 
  \item \hypertarget{ans:quNormZm0.11}{\ref{revex:quNormZm0.11}} -- \Sexpr{formatC(100*distrib(-0.11,lower.tail=FALSE,plot=FALSE),format="f",digits=1)}\%, as computed with
<<par1a=TRUE>>=
( distrib(-0.11,mean=0,sd=1,lower.tail=FALSE) )
@ 
  \item \hypertarget{ans:quNormZbtwn}{\ref{revex:quNormZbtwn}} -- \Sexpr{formatC(100*distrib(1.11,plot=FALSE)-100*distrib(-1.45,plot=FALSE),format="f",digits=1)}\%, as computed with
<<par1a=TRUE>>=
( ab <- distrib(1.11,mean=0,sd=1) )
( a <- distrib(-1.45,mean=0,sd=1) )
ab-a
@ 
  \item \hypertarget{ans:quNormXgt75}{\ref{revex:quNormXgt75}} -- \Sexpr{formatC(100*distrib(75,mean=70,sd=6,lower.tail=FALSE,plot=FALSE),format="f",digits=1)}\%, as computed with
<<par1a=TRUE>>=
( distrib(75,mean=70,sd=6,lower.tail=FALSE) )
@ 
  \item \hypertarget{ans:quNormXlt63}{\ref{revex:quNormXlt63}} -- \Sexpr{formatC(100*distrib(63,mean=70,sd=6,plot=FALSE),format="f",digits=1)}\%, as computed with
<<par1a=TRUE>>=
( distrib(63,mean=70,sd=6) )
@ 
  \item \hypertarget{ans:quNormXbtwn}{\ref{revex:quNormXbtwn}} --  \Sexpr{formatC(100*distrib(72.9,mean=70,sd=6,plot=FALSE)-100*distrib(62.3,mean=70,sd=6,plot=FALSE),format="f",digits=1)}\%, as computed with
<<par1a=TRUE>>=
...
@ 
  ...
  \item \hypertarget{ans:quNormXrev03}{\ref{revex:quNormXrev03}} -- \Sexpr{formatC(distrib(0.3,type="q",mean=70,sd=6,plot=FALSE),format="f",digits=2)}, as computed with
<<par1a=TRUE>>=
( distrib(0.3,mean=70,sd=6,type="q") )
@ 
  \item \hypertarget{ans:quNormXrev04}{\ref{revex:quNormXrev04}} -- \Sexpr{formatC(distrib(0.4,type="q",mean=70,sd=6,lower.tail=FALSE,plot=FALSE),format="f",digits=2)}, as computed with
<<par1a=TRUE>>=
( distrib(0.4,mean=70,sd=6,type="q",lower.tail=FALSE) )
@ 
  \item \hypertarget{ans:quNormXrev05}{\ref{revex:quNormXrev05}} -- \Sexpr{formatC(distrib(0.25,type="q",mean=70,sd=6,plot=FALSE),format="f",digits=2)} and \Sexpr{formatC(distrib(0.75,type="q",mean=70,sd=6,plot=FALSE),format="f",digits=2)}, as computed with
<<par1a=TRUE>>=
...
@ 
  ...
  \item \hypertarget{ans:quNormStudentAge}{\ref{revex:quNormStudentAge}} --
    \begin{enumerate}
      \item Approximately \Sexpr{formatC(100*distrib(21,mean=22.1,sd=1.1,plot=FALSE),format="f",digits=1)}\% of student would graduate by 21, as computed with
<<par1a=TRUE>>=
( distrib(21,mean=22.1,sd=1.1) )
@ 
      \item Approximately \Sexpr{formatC(100*distrib(24,mean=22.1,sd=1.1,lower.tail=FALSE,plot=FALSE),format="f",digits=1)}\% of students would graduate after age 24, as computed with
<<par1a=TRUE>>=
( distrib(24,mean=22.1,sd=1.1,lower.tail=FALSE) )
@
      \item The middle 95\% of student would graduate between \Sexpr{formatC(distrib(0.025,type="q",mean=22.1,sd=1.1,plot=FALSE),format="f",digits=1)} and \Sexpr{formatC(distrib(0.975,type="q",mean=22.1,sd=1.1,plot=FALSE),format="f",digits=1)} years old, as computed with
<<par1a=TRUE>>=
( distrib(0.025,mean=22.1,sd=1.1,type="q") )
( distrib(0.975,mean=22.1,sd=1.1,type="q") )
@
      \item By age \Sexpr{formatC(distrib(0.90,type="q",mean=22.1,sd=1.1,plot=FALSE),format="f",digits=1)}, 90\% of students will have graduated, as computed with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:quNormBlackBears}{\ref{revex:quNormBlackBears}} --
    \begin{enumerate}
      \item Approximately \Sexpr{formatC(100*distrib(65,mean=60,sd=10,plot=FALSE)-100*distrib(45,mean=60,sd=10,plot=FALSE),format="f",digits=1)}\% of bears have a body length between 45" and 65", as computed with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:quNormShrews}{\ref{revex:quNormShrews}} -- 
    \begin{enumerate}
      \item Approximately \Sexpr{formatC(100*distrib(0.09,mean=0.14,sd=0.04,plot=FALSE),format="f",digits=1)}\% of shrews have a brain weight less than 0.09 g, as computed with
<<par1a=TRUE>>=
( distrib(0.09,mean=0.14,sd=0.04) )
@ 
      \item Approximately \Sexpr{formatC(100*distrib(0.17,mean=0.14,sd=0.04,plot=FALSE)-100*distrib(0.09,mean=0.14,sd=0.04,plot=FALSE),format="f",digits=1)}\% of shrews have a brain weight between 0.09 and 0.17 g, as computed with
<<par1a=TRUE>>=
( ab <- distrib(0.17,mean=0.14,sd=0.04) )
( a <- distrib(0.09,mean=0.14,sd=0.04) )
ab-a
@
      \item The largest 30\% brain weights for shrews are larger than \Sexpr{formatC(distrib(0.30,type="q",mean=0.14,sd=0.04,lower.tail=FALSE,plot=FALSE),format="f",digits=2)} g, as computed with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:quNormBart}{\ref{revex:quNormBart}}
    \begin{enumerate}
      \item Approximately \Sexpr{formatC(100*distrib(5,sd=3,lower.tail=FALSE,plot=FALSE),format="f",digits=1)}\% of arrivals are more than five minutes late, as computed with
<<par1a=TRUE>>=
( distrib(5,mean=0,sd=3,lower.tail=FALSE) )
@
      \item Approximately \Sexpr{formatC(100*distrib(-4,sd=3,plot=FALSE),format="f",digits=1)}\% of arrivals are more than four minutes early, as computed with
<<par1a=TRUE>>=
( distrib(-4,mean=0,sd=3) )
@
      \item Approximately \Sexpr{formatC(100*distrib(4,sd=3,plot=FALSE)-100*distrib(-4,sd=3,plot=FALSE),format="f",digits=1)}\% of arrivals are between four minutes early and four minutes late, as computed with
<<par1a=TRUE>>=
( ab <- distrib(4,mean=0,sd=3) )
( a <- distrib(-4,mean=0,sd=3) )
ab-a
@
      \item The latest 25\% of arrival times are later than \Sexpr{formatC(distrib(0.25,type="q",sd=3,lower.tail=FALSE,plot=FALSE),format="f",digits=1)} minutes late, as computed with
<<par1a=TRUE>>=
( distrib(0.25,mean=0,sd=3,type="q",lower.tail=FALSE) )
@
      \item The most common 60\% of arrival times are between \Sexpr{formatC(distrib(0.2,type="q",sd=3,plot=FALSE),format="f",digits=1)} and \Sexpr{formatC(distrib(0.8,type="q",sd=3,plot=FALSE),format="f",digits=1)}, as computed with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:quNormRoeDeer}{\ref{revex:quNormRoeDeer}} -- 
    \begin{enumerate}
      \item Approximately \Sexpr{formatC(100*distrib(2,mean=2.235,sd=0.460,plot=FALSE),format="f",digits=1)}\% of does have less than 2 fawns, as computed with
<<par1a=TRUE>>=
( distrib(2,mean=2.235,sd=0.460) )
@
      \item Approximately \Sexpr{formatC(100*distrib(3,mean=2.235,sd=0.460,lower.tail=FALSE,plot=FALSE),format="f",digits=1)}\% of does have more than 3 fawns, as computed with
<<par1a=TRUE>>=
( distrib(3,mean=2.235,sd=0.460,lower.tail=FALSE) )
@ 
      \item Approximately \Sexpr{formatC(100*distrib(3,mean=2.235,sd=0.460,plot=FALSE)-100*distrib(1,mean=2.235,sd=0.460,plot=FALSE),format="f",digits=1)}\% of does have between 1 and 3 fawns, as computed with
<<par1a=TRUE>>=
( ab <- distrib(3,mean=2.235,sd=0.460) )
( a <- distrib(1,mean=2.235,sd=0.460) )
ab-a
@
      \item The lowest 7.6\% of does have fewer than \Sexpr{formatC(distrib(0.076,type="q",mean=2.235,sd=0.460,plot=FALSE),format="f",digits=1)} fawns, as computed with
<<par1a=TRUE>>=
( distrib(0.076,mean=2.235,sd=0.460,type="q") )
@
      \item The upper 4.2\% of does have more than \Sexpr{formatC(distrib(0.042,type="q",mean=2.235,sd=0.460,lower.tail=FALSE,plot=FALSE),format="f",digits=1)} fawns, as computed with
<<par1a=TRUE>>=
( distrib(0.042,mean=2.235,sd=0.460,type="q",lower.tail=FALSE) )
@
      \item The most common 87\% of does have between \Sexpr{formatC(distrib(0.065,type="q",mean=2.235,sd=0.460,plot=FALSE),format="f",digits=1)} and \Sexpr{formatC(distrib(0.935,type="q",mean=2.235,sd=0.460,plot=FALSE),format="f",digits=1)} fawns, as computed with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:quNormCrayfish}{\ref{revex:quNormCrayfish}} --
    \begin{enumerate}
      \item The percentage that are acceptable is \Sexpr{formatC(100*distrib(110,mean=93,sd=8,plot=FALSE)-100*distrib(90,mean=93,sd=8,plot=FALSE),format="f",digits=1)}\%, as computed with
<<par1a=TRUE>>=
( ab <- distrib(110,mean=93,sd=8) )
( a <- distrib(90,mean=93,sd=8) )
ab-a
@
Thus, the number out of 50000 that I could sell is \Sexpr{formatC(50000*(ab-a),0)} crayfish.
      \item The percentage that are greater than 110 mm is \Sexpr{formatC(100*distrib(110,mean=93,sd=8,lower.tail=FALSE,plot=FALSE),format="f",digits=1)}\%, as computed with
<<par1a=TRUE>>=
( distrib(110,mean=93,sd=8,lower.tail=FALSE) )
@
Thus, the number out of 50000 that I could sell is \Sexpr{formatC(50000*distrib(110,mean=93,sd=8,lower.tail=FALSE,plot=FALSE),format="f",digits=0)} crayfish.
    \end{enumerate}  
...
<<echo=FALSE, results='hide'>>=
saplings <- c(0.95,2.89,2.97,3.94,4.74,5.10,6.64,7.13)
browse <- c(0.31,0.35,0.49,0.50,0.61,0.63,0.86,0.90)
df <- data.frame(saplings,browse)
@
<<eval=FALSE>>=
df <- read.table("data/Hemlock.txt",header=TRUE)
@
<<HemDeerPlot, fig.width=3.5, fig.height=3.5, fig.cap="Scatterplot of mean number hemlock saplings versus a deer browsing index.", par1=TRUE>>=
...
The relationship between mean number of hemlock saplings and the deer browse index is positive, mostly linear, visually strong, and without obvious outliers \figrefp{fig:HemDeerPlot}.
  ...
  \item \hypertarget{ans:qbEDAcorr}{\ref{revex:qbEDAcorr}} -- The correlation is \Sexpr{formatC(cor(saplings,browse),format="f",digits=2)} computed with (assuming the data entered above),
<<>>=
...
<<echo=FALSE>>=
## this is here as used in the answer below
r <- read.table("data/rifa.txt",header=TRUE)
@
  \item \hypertarget{ans:qbEDAAllen}{\ref{revex:qbEDAAllen}} -- The bivariate relationship shows a negative association, linear form, moderately strong strength ($r$=\Sexpr{formatC(cor(r$fawnrec,r$rifa),format="f",digits=2)}), and no obvious outliers \figrefp{fig:RIFA}.  It is safe to report $r$ because of the linearity evident in the relationship.  This analysis was performed with
<<ScatRIFA, results='hide', fig.width=3.5, fig.height=3.5, fig.cap="Scatterplot of RIFA index versus fawn recruit index.", par1=TRUE>>=
r <- read.table("data/rifa.txt",header=TRUE)
...
@
  \item \hypertarget{ans:qbEDAMlad}{\ref{revex:qbEDAMlad}} -- The bivariate relationship shows a negative association, linear (though I could see where someone would say that it is a very slightly curved form), moderate strength ($r$=\Sexpr{formatC(cor(ml$terr,ml$deer),format="f",digits=2)}), and no obvious outliers \figrefp{fig:Wolves2Plot}.  It is safe to report $r$ because of the linearity evident in the relationship.  These results were obtained with
<<Wolves2Plot, results='hide', fig.width=3.5, fig.height=3.5, fig.cap="Scatterplot of wolf territory size versus deer density.", par1=TRUE>>=
ml <- read.table("data/Wolves2.txt",header=TRUE)
...
<<PerchGLPlot, fig.width=3.5, fig.height=3.5, par1=TRUE>>=
...
@
  \item \hypertarget{ans:qbEDACrckt}{\ref{revex:qbEDACrckt}} -- The bivariate relationship shows a positive association, linear form, moderate strength ($r$=\Sexpr{formatC(cor(ch$chirps,ch$temp),format="f",digits=3)}), and no obvious outliers \figrefp{fig:ChirpsPlot}.  You should also note that the relationship appears to get weaker as the explanatory variable decreases.  It is safe to report $r$ because of the linear form and absence of outliers.  These results were obtained with
<<ChirpsPlot, echo=FALSE, results='hide', fig.width=3.5, fig.height=3.5, par1=TRUE>>=
ch <- read.table("data/Chirps.txt",header=TRUE)
plot(temp~chirps,data=ch,xlab="Density of Deer",ylab="Wolf Territor Size",pch=19)
@
  ...
  \begin{enumerate}
    \item Approximately \Sexpr{formatC(27/47*100,format="f",digits=1)}\% of elephant seals were male ($\frac{27}{47}*100$).  [No restriction, use margin.]
    \item Approximately \Sexpr{formatC(7/27*100,format="f",digits=1)}\% of male elephant seals were observed in July ($\frac{7}{27}*100$).  [Restricted to males.]
    \item Approximately \Sexpr{formatC(25/47*100,format="f",digits=1)}\% of elephant seals were observed in August ($\frac{25}{27}*100$).  [No restriction, use margin.]
    \item Approximately \Sexpr{formatC(2/47*100,format="f",digits=1)}\% of elephant seals were female and observed in July ($\frac{2}{47}*100$).  [No restriction.]
  \end{enumerate}

  \item \hypertarget{ans:cbEDAWeitz}{\ref{revex:cbEDAWeitz}} --
  \begin{enumerate}
    \item Approximately \Sexpr{formatC(21/47*100,format="f",digits=1)}\% of Jewish physicians supported genetic counseling ($\frac{21}{47}*100$).  [Restricted to Jewish.]
    \item Approximately \Sexpr{formatC(52/62*100,format="f",digits=1)}\% of Catholic physicians did not support genetic counseling ($\frac{52}{62}*100$).  [Restricted to Catholic.]
    \item Approximately \Sexpr{formatC(178/287*100,format="f",digits=1)}\% of all physicians were Protestant ($\frac{178}{287}*100$).  [No restrictions, use margins.]
    \item Approximately \Sexpr{formatC(52/220*100,format="f",digits=1)}\% of physicians that did not support genetic counseling were Catholic ($\frac{52}{220}*100$).  [Restricted to Don't Support.]
    \item Approximately \Sexpr{formatC(67/287*100,format="f",digits=1)}\% of all physicians supported genetic counseling ($\frac{67}{287}*100$).  [No restrictions, use margins.]
  \end{enumerate}

  \item \hypertarget{ans:cbEDAGulls}{\ref{revex:cbEDAGulls}} --
  \begin{enumerate}
    \item Approximately \Sexpr{formatC(4/42*100,format="f",digits=1)}\% of gulls that died in New Jersey died in July ($\frac{4}{42}*100$).  [Restricted to New Jersey.]
    \item Approximately \Sexpr{formatC(18/688*100,format="f",digits=1)}\% of all gulls died in July ($\frac{18}{688}*100$).  [No restrictions, use margins.]
    \item Approximately \Sexpr{formatC(130/688*100,format="f",digits=1)}\% of all gulls died in The Netherlands in September ($\frac{130}{688}*100$).  [No restrictions.]
  \end{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Approximately \Sexpr{formatC(20/30*100,format="f",digits=1)}\% of rainy days in August has more than 1 inche of rain ($\frac{20}{30}*100$).  [Restricted to August.]
    \item Approximately \Sexpr{formatC(20/31*100,format="f",digits=1)}\% of all days in July had rain ($\frac{20}{31}*100$).  [Restricted to given days in July.]
    \item Approximately \Sexpr{formatC(24/62*100,format="f",digits=1)}\% of all rainy days had more than 1 inch of rain ($\frac{24}{62}*100$).  [No restrictions.]
    \item Approximately \Sexpr{formatC(12/62*100,format="f",digits=1)}\% of all rainy days were in June ($\frac{12}{62}*100$).  [No restrictions, use margins.]
  \end{enumerate}
 
<<echo=FALSE, results='hide'>>=
mon <- factor(c("Jun","Jun","Jun","Jun","Jun","Jun","Jun","Jun","Jul","Jul",
"Jul","Jul","Jul","Jul","Jul","Aug","Aug","Aug","Aug","Aug","Aug","Aug","Aug",
"Aug","Aug","Aug","Aug","Jun","Jun","Jun","Jun","Jun","Jul","Jul","Aug","Aug",
"Aug","Aug","Aug","Aug","Aug","Aug","Aug","Aug","Aug","Aug","Aug"))
fmon <- factor(mon,levels=c("Jun","Jul","Aug"))
sex <- factor(c("M","M","M","M","M","M","M","M","M","M","M","M","M","M","M","M",
"M","M","M","M","M","M","M","M","M","M","M","F","F","F","F","F",
"F","F","F","F","F","F","F","F","F","F","F","F","F","F","F"))
seals <- data.frame(mon,sex,fmon) 
@
...
gss2 <- read.table("data/GSSEnviroQues.txt",header=TRUE)
gss2$frecycle <- factor(gss2$recycle,levels=c("Always","Often","Sometimes","Never","Not Avail"))
gss2$ftempgen <- factor(gss2$tempgen,levels=c("Extremely","Very","Somewhat","Not Very","Not"))
tbl1 <- xtabs(~frecycle+ftempgen,data=gss2)
tbl2 <- addMargins(tbl1)
xtbl2 <- xtable(tbl2,digits=0,caption="Frequency table of respondents by answers to the two questions on the GSS.","tab:GSS2Freq")
print(xtbl2,caption.placement="top")
@
  \item \hypertarget{ans:cbEDAGSS2}{\ref{revex:cbEDAGSS2}} -- The frequency table for this question is shown in \tabref{tab:GSS2Freq}.
    \begin{enumerate}
      \item Approximately \Sexpr{formatC(100*tbl2["Often","Very"]/tbl2["Sum","Sum"],format="f",digits=1)}\% of all respondents recycle often and feel that it is very likely that the greenhouse effect has caused the rise in world's temperature (100*\Sexpr{tbl2["Often","Very"]}/\Sexpr{tbl2["Sum","Sum"]}).
      \item Approximately \Sexpr{formatC(100*tbl2["Often","Very"]/tbl2["Often","Sum"],format="f",digits=1)}\%  of those respondents that recycle often feel that it is very likely that the greenhouse effect has caused the rise in world's temperature (100*\Sexpr{tbl2["Often","Very"]}/\Sexpr{tbl2["Often","Sum"]}).
      \item Approximately \Sexpr{formatC(100*tbl2["Often","Very"]/tbl2["Sum","Very"],format="f",digits=1)}\%  of those respondents that think it is very likely that the greenhouse effect has caused the rise in world's temperature also recycle often (100*\Sexpr{tbl2["Often","Very"]}/\Sexpr{tbl2["Sum","Very"]}).
      \item Approximately \Sexpr{formatC(100*tbl2["Often","Sum"]/tbl2["Sum","Sum"],format="f",digits=1)}\%  of all respondents recycle often (100*\Sexpr{tbl2["Often","Sum"]}/\Sexpr{tbl2["Sum","Sum"]}).
      \item Approximately \Sexpr{formatC(100*tbl2["Sum","Very"]/tbl2["Sum","Sum"],format="f",digits=1)}\%  of all respondents think it is very likely that the greenhouse effect has caused the rise in world's temperature (100*\Sexpr{tbl2["Sum","Very"]}/\Sexpr{tbl2["Sum","Sum"]}).
    \end{enumerate}

<<echo=FALSE, results='asis'>>=
d <- read.csv("data/Zoo1.csv",header=TRUE)
tbl1 <- xtabs(~zoo+type,data=d)
tbl2 <- addMargins(tbl1)
xtbl2 <- xtable(tbl2,digits=0,caption="Frequency table of animals by broad animal type and location of the zoo.","tab:Zoo1Freq")
print(xtbl2,caption.placement="top")
@
  \item \hypertarget{ans:cbEDAZoo1}{\ref{revex:cbEDAZoo1}} -- The frequency table for this question is shown in \tabref{tab:Zoo1Freq}.
    \begin{enumerate}
      ...
      \item Approximately \Sexpr{formatC(100*tbl2["Sum","bird"]/tbl2["Sum","Sum"],format="f",digits=1)}\% of all animals were birds (100*\Sexpr{tbl2["Sum","bird"]}/\Sexpr{tbl2["Sum","Sum"]}).
      \item Approximately \Sexpr{formatC(100*tbl2["Minnesota","bird"]/tbl2["Minnesota","Sum"],format="f",digits=1)}\% of all animals in the Minnesota zoo were birds (100*\Sexpr{tbl2["Minnesota","bird"]}/\Sexpr{tbl2["Minnesota","Sum"]}).
      \item Approximately \Sexpr{formatC(100*tbl2["Chicago (Lincoln Park)","amph/rep"]/tbl2["Chicago (Lincoln Park)","Sum"],format="f",digits=1)}\% of all animals in the Chicago zoo were amphibians/reptiles (100*\Sexpr{tbl2["Chicago (Lincoln Park)","amph/rep"]}/\Sexpr{tbl2["Chicago (Lincoln Park)","Sum"]}).
      \item Approximately \Sexpr{formatC(100*tbl2["Chicago (Lincoln Park)","Sum"]/tbl2["Sum","Sum"],format="f",digits=1)}\% of all animals were in the Chicago zoo (100*\Sexpr{tbl2["Chicago (Lincoln Park)","Sum"]}/\Sexpr{tbl2["Sum","Sum"]}).
      \item Approximately \Sexpr{formatC(100*tbl2["Minnesota","bird"]/tbl2["Sum","bird"],format="f",digits=1)}\% of all birds were in the Minnesota zoo (100*\Sexpr{tbl2["Minnesota","bird"]}/\Sexpr{tbl2["Sum","bird"]}).
    \end{enumerate}
\end{itemize}
...
@
      \item The equation of the best-fit line is \var{winglen} = \Sexpr{formatC(coef(fc.lm)[1],format="f",digits=3)}\Sexpr{formatC(coef(fc.lm)[2],format="f",digits=3)}\var{date}.  The coefficients were found with
<<>>=
( fc.lm <- lm(winglen~date,data=fc) )
@
      \item When the date is 0 (January 1), then the wing length will be \Sexpr{formatC(coef(fc.lm)[1],format="f",digits=3)} mm, on average.
      \item For each day increase in the migration, the average wing length decreases by \Sexpr{formatC(-1*coef(fc.lm)[2],format="f",digits=3)} mm.
      \item This is 10 times the unit change in length by day. Thus, $10*$\Sexpr{formatC(coef(fc.lm)[2],format="f",digits=3)} = \Sexpr{formatC(10*coef(fc.lm)[2],format="f",digits=2)}.
      \item This prediction should not be made as date=180 is outside the domain of the data.
      \item The residual is \Sexpr{formatC(66.5 - predict(fc.lm,data.frame(date=151)),format="f",digits=1)} as found with
<<>>=
66.5 - predict(fc.lm,data.frame(date=151))
@
      \item The proportion of variability explained by knowing the date is $r^{2}$ = \Sexpr{formatC(rSquared(fc.lm),format="f",digits=3)} as found with
<<>>=
rSquared(fc.lm)
@
      \item The correlation coefficient is $r$ = \Sexpr{formatC(-1*sqrt(rSquared(fc.lm)),format="f",digits=3)}. [$\sqrt{r^{2}}$], but don't forget the negative sign because of negative association in the plot.]
...
<<FlyCatFitPlot, fig.width=3.5, fig.height=3.5, fig.cap="Fitted line plot for the relationship between flycatcher wing length and the days since January 1.", par1=TRUE>>=
...
@
    \begin{enumerate}
      ...
      \item The equation of the best-fit line is \var{adjdeath} = \Sexpr{formatC(coef(cf.lm)[1],format="f",digits=3)} + \Sexpr{formatC(coef(cf.lm)[2],format="f",digits=3)}*\var{fatintake}.  The coefficients are found with
<<>>=
( cf.lm <- lm(adjdeath~fatintake,data=cf) )
@
      \item The interpretation of the slope is that for every increase of 1 g/day consumption of animal fat the per capita death rate due to breast cancer will increase \Sexpr{formatC(coef(cf.lm)[2],format="f",digits=3)} units, on average.
      \item Because of the interpretation of the slope, country A will have an age adjusted death rate due to breast cancer that is $(-4)*$\Sexpr{formatC(coef(cf.lm)[2],format="f",digits=3)} = \Sexpr{formatC(4*coef(cf.lm)[1],format="f",digits=3)} units \textbf{lower} than country B, on average.
      ...
      \item  The residual is \Sexpr{formatC(14.5 - predict(cf.lm,data.frame(fatintake=90)),format="f",digits=1)} as found with
<<>>=
14.5 - predict(cf.lm,data.frame(fatintake=90))
@
      \item The correlation coefficient is \Sexpr{formatC(sqrt(rSquared(cf.lm)),format="f",digits=3)} and is found by taking the square root of $r^{2}$ with
<<>>=
rSquared(cf.lm)
@
      \item This is simply a definition of $r^{2}$=\Sexpr{formatC(rSquared(cf.lm),format="f",digits=3)} which is found above.
...
@
      \item The equation of the best-fit line is \var{fawnrec} = \Sexpr{formatC(coef(r.lm)[1],format="f",digits=3)}\Sexpr{formatC(coef(r.lm)[2],format="f",digits=6)}\var{rifa}.  The coefficients were found with
<<>>=
( r.lm <- lm(fawnrec~rifa,data=r) )
@
      \item For every 1 unit increase in RIFA the fawn recruitment index \textbf{declines} by \Sexpr{formatC(-1*coef(r.lm)[2],format="f",digits=6)} units, on average.
      \item If RIFA index increases by 500, then fawn recruitment will increase by 500 times the unit change (\Sexpr{formatC(-1*coef(r.lm)[2],format="f",digits=6)}) or \Sexpr{formatC(500*coef(r.lm)[2],format="f",digits=6)}.
      \item The predicted values is \Sexpr{formatC(predict(r.lm,data.frame(rifa=1700)),format="f",digits=3)} as found with
<<>>=
...
@
      ...
      \item This is $r$ which is found with the $\sqrt{r^{2}}$=\Sexpr{formatC(-1*sqrt(rSquared(r.lm)),format="f",digits=3)} where $r^{2}$ is found in the next question.  Note that the sign is needed because there is a negative association.
      \item The proportion of variability explained by knowing the RIFA index is $r^{2}$ = \Sexpr{formatC(rSquared(r.lm),format="f",digits=3)} as found with
<<>>=
rSquared(r.lm)
@
...
<<RIFAFitPlot, fig.width=3.5, fig.height=3.5, fig.cap="Fitted line plot for the relationship between fawn recruitment and RIFA index.", par1=TRUE>>=
...
@
      \item For each increase in ACT score of 1 point, the math assessment score will increase approximately \Sexpr{formatC(coef(ma.lm)[2],format="f",digits=3)} points, on average.  The value of this coefficient was found with
<<>>=
( ma.lm <- lm(assess~act,data=ma) )
@
      ...
      \item The ACT score of 19 is within the range of the data, so the prediction is \Sexpr{formatC(predict(ma.lm,data.frame(act=19)),format="f",digits=1)} as found with
<<>>=
predict(ma.lm,data.frame(act=19))
@
      \item The residual is \Sexpr{formatC(15-predict(ma.lm,data.frame(act=19)),format="f",digits=1)} as found with
<<>>=
15-predict(ma.lm,data.frame(act=19))
@
      \item The proportion of variability explained by knowing the ACT score is $r^{2}$ = \Sexpr{formatC(rSquared(ma.lm),format="f",digits=3)}with
<<>>=
rSquared(ma.lm)
@
...
<<NCAssessFitPlot, fig.width=3.5, fig.height=3.5, fig.cap="Fitted-line plot for the relationship between ACT score and math assessment score.", par1=TRUE>>=
...
@
      \item The equation of the best-fit line is \var{Fresh} = \Sexpr{formatC(coef(ff.lm)[1],format="f",digits=3)} + \Sexpr{formatC(coef(ff.lm)[2],format="f",digits=3)}*\var{Frozen}.  The coefficients were found with
<<>>=
( ff.lm <- lm(fresh~frozen,data=ff) )
@
      \item For every unit increase of the frozen sample the fresh sample increases by \Sexpr{formatC(coef(ff.lm)[2],format="f",digits=3)} units, on average.
      \item This prediction cannot be made because it would be an extrapolation
      \item The residual is \Sexpr{formatC(2.1 - predict(ff.lm,data.frame(frozen=2.2)),format="f",digits=5)} as found with
<<>>=
2.1 - predict(ff.lm,data.frame(frozen=2.2))
@
      \item The proportion of variability explained by knowing the value of the frozen sample is $r^{2}$ = \Sexpr{formatC(rSquared(ff.lm),format="f",digits=3)} with
<<>>=
rSquared(ff.lm)
@
      \item The correlation coefficient is $r$ = \Sexpr{formatC(sqrt(rSquared(ff.lm)),format="f",digits=3)} (the square root of $r^{2}$ shown in the previous answer).
...
<<dnaFitPlot, fig.width=3.5, fig.height=3.5, fig.cap="Fitted-line plot for the relationship between fresh and frozen DNA samples.", par1=TRUE>>=
fitPlot(ff.lm,main="")
@
    \end{enumerate}
...
@
      \item The equation of the best-fit line is \var{fawns} = \Sexpr{formatC(coef(d.lm)[2],format="f",digits=3)}*\var{precip} + \Sexpr{formatC(coef(d.lm)[1],format="f",digits=3)}.  The coefficients were found with
<<>>=
( d.lm <- lm(fawns~precip,data=d) )
@
      \item The mean number of fawns per 100 does will \textbf{decrease} by \Sexpr{formatC(coef(d.lm)[2],format="f",digits=3)} units for every 1 unit increase in mean precipitation, on average.
      \item This prediction cannot be made because 1500 mm is out of the range of observed precipations
      \item The residual is \Sexpr{formatC(37-predict(d.lm,data.frame(precip=1050)),format="f",digits=3)} as found with
<<>>=
37-predict(d.lm,data.frame(precip=1050))
@
      \item The correlation coefficient is $r$ which is found with the $\sqrt{r^{2}}$=\Sexpr{formatC(-1*sqrt(rSquared(d.lm)),format="f",digits=3)} where $r^{2}$ is found in the next question.
      \item The proportion of variability explained by knowing precipitation is $r^{2}$ = \Sexpr{formatC(rSquared(d.lm),format="f",digits=3)} as found with
<<>>=
rSquared(d.lm)
@
      \item If precipitation increases by 100 mm, then the number of fawns per 100 does decreases by \Sexpr{formatC(-100*coef(d.lm)[2],format="f",digits=3)} (i.e., $100$*\Sexpr{formatC(coef(d.lm)[2],format="f",digits=3)}).
    \end{enumerate}

  \item \hypertarget{ans:RegChirps}{\ref{revex:RegChirps}} --   The data were read into R with
<<echo=FALSE, results='hide'>>=
if ("temp" %in% ls()) rm(temp)
@
<<>>=
ch <- read.table("data/chirps.txt",header=TRUE)
str(ch)
...
@
      \item The equation of the best-fite line is \var{temp} = \Sexpr{formatC(coef(ch.lm)[2],format="f",digits=3)}*\var{chirps} + \Sexpr{formatC(coef(ch.lm)[1],format="f",digits=3)}.  The coefficients were found with
<<>>=
( ch.lm <- lm(temp~chirps,data=ch) )
@
      \item For every increase of one chirp the predicted temperature will increase by \Sexpr{formatC(coef(ch.lm)[1],format="f",digits=3)}, on average.
      \item If the number of chirps increases by 5, then the predicted temperature should increase by five ``slopes'' or \Sexpr{formatC(5*coef(ch.lm)[1],format="f",digits=3)}, on average.
      \item This is basically the same as the previous question -- the difference in predicted temperature should be three ``slopes'' or \Sexpr{formatC(3*coef(ch.lm)[1],format="f",digits=3)}.  Thus, it will be \Sexpr{formatC(3*coef(ch.lm)[1],format="f",digits=3)} degrees warmer during the day, on average.
      ...
      \item The correlation coefficient is $r$ which is found with the $\sqrt{r^{2}}$=\Sexpr{formatC(sqrt(rSquared(ch.lm)),format="f",digits=3)} where $r^{2}$ is found in the next question.
      \item The proportion of variability explained by knowing the number of chirps is $r^{2}$ = \Sexpr{formatC(rSquared(ch.lm),format="f",digits=3)} as found with
<<>>=
rSquared(ch.lm)
@
...
<<ChirpsFitPlot, fig.width=3.5, fig.height=3.5, fig.cap="Fitted-line plot for the relationship between temperature and the number of chirps.", par1=TRUE>>=
fitPlot(ch.lm,main="")
@
    \end{enumerate}
...
\cline{2-4}
\multicolumn{1}{c|}{50C} & \Sexpr{paste(vsls[1:5],collapse=",")} & \Sexpr{paste(vsls[6:10],collapse=",")} & \multicolumn{1}{c|}{\Sexpr{paste(vsls[11:15],collapse=",")}} \\
\hline
\multicolumn{1}{c|}{60C} & \Sexpr{paste(vsls[16:20],collapse=",")} & \Sexpr{paste(vsls[21:25],collapse=",")} & \multicolumn{1}{c|}{\Sexpr{paste(vsls[26:30],collapse=",")}} \\
\cline{2-4}
\end{tabular}
    \end{enumerate}
...
\hline
\multicolumn{1}{c|}{Yes} & \Sexpr{paste(mls[1:8],collapse=",")} & \multicolumn{1}{c|}{\Sexpr{paste(mls[9:16],collapse=",")}} \\
\hline
\multicolumn{1}{c|}{No} & \Sexpr{paste(mls[17:24],collapse=",")} &  \multicolumn{1}{c|}{\Sexpr{paste(mls[25:32],collapse=",")}} \\
\cline{2-3}
\end{tabular}
    \end{enumerate}
...
\begin{itemize}  
  ...
  \begin{enumerate}
    \item The probability that a randomly selected needle is between 70 and 80 mm long is \Sexpr{formatC(distrib(80,mean=75,sd=8,plot=FALSE)-distrib(70,mean=75,sd=8,plot=FALSE),digits=4,format="f")} as computed with
<<par1a=TRUE>>=
ab <- distrib(80,mean=75,sd=8)
a <- distrib(70,mean=75,sd=8)
ab-a
@
    \item The probability that a randomly selected needle is longer than 90 mm is \Sexpr{formatC(distrib(90,mean=75,sd=8,lower.tail=FALSE,plot=FALSE),digits=4,format="f")} as computed with
<<par1a=TRUE>>=
distrib(90,mean=75,sd=8,lower.tail=FALSE)
@
    \item The probability that a randomly selected needle is less than 50 mm is \Sexpr{formatC(distrib(50,mean=75,sd=8,plot=FALSE),digits=4,format="f")} as computed with
<<par1a=TRUE>>=
...
<<Quiz4, echo=FALSE, fig.width=3.5, fig.height=3.5, fig.cap="Sampling distribution of mean quiz scores from samples of $n=4$ from the simple population of quiz scores.", par1=TRUE>>=
hist(mns4,xlab="Sample Mean",ylab="Frequency of Samples",breaks=seq(5.25,7,0.25),right=FALSE,col="gray95",main="",xlim=c(5.25,7))
@
      \item The mean of all fifteen sample means is \Sexpr{formatC(sum4["mean"],format="f",digits=3)}, as is the mean of the six individuals in the population.
      \item The standard deviation of the fifteen sample means is \Sexpr{formatC(sum4["sd"],format="f",digits=3)} which is less than the standard deviation of the six individuals (1.414) and the standard deviation of the means from $n=2$ (0.845) and $n=3$ (0.593).  It appears that the standard deviation of the means decreases with increasing $n$.
<<eval=FALSE>>=
scores <- c(6,6,4,5,7,8)
mns4 <- combn(scores,4,mean)
sum4 <- Summarize(mns4)
...
<<Yes3, echo=FALSE, fig.width=3.5, fig.height=3.5, fig.cap="Sampling distribution of proportion of ``yeses''from samples of $n=3$.", par1=TRUE>>=
barplot(table(pyes),names.arg=c("0","1/3","2/3","1"),space=0,xlab="Sample Proportion",
        ylab="Frequency of Samples",col="gray95",main="",ylim=c(0,20))
@
      \item The mean of the 35 sample proportions is \Sexpr{formatC(sumYes["mean"],format="f",digits=3)} which is the same as the proportion of ``yeses'' for the population (i.e., $\frac{4}{7}=$\Sexpr{formatC(4/7,format="f",digits=3)}).
      \item The standard deviation of the 35 sample proportions is \Sexpr{formatC(sumYes["sd"],format="f",digits=3)}.
<<eval=FALSE>>=
popn <- c("Y","Y","N","Y","Y","N","N")
smpl3 <- combn(popn,3)
tblyes <- function(x) {
...
@
  ...
  \end{enumerate}
    ...
    \begin{enumerate}
      ...
      \item This question is about a quantitative variable and a statistic; thus, the sampling distribution of $\bar{x}$ would be used.  Because the population distribution is only symmetric, the sample size must be greater than 15, which it is in this question.  Thus, $\bar{x}\sim N(40,\frac{15}{\sqrt{25}})$ or $\bar{x}\sim N(40,3)$.  Thus, the probability is \Sexpr{formatC(distrib(48,mean=40,sd=15/sqrt(25),lower.tail=FALSE,plot=FALSE),digits=4,format="f")}, as computed with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:CLTWr}{\ref{revex:CLTWr}} --
    \begin{enumerate}
       ...
       \item This question is about a statistic; thus, the sampling distribution of sample means should be used.  The probability of observing a stressed population (i.e., mean less than 0.95) is \Sexpr{formatC(distrib(0.95,mean=1,sd=0.2/sqrt(36),plot=FALSE),digits=4,format="f")}, as computed with
<<par1a=TRUE>>=
( distrib(0.95,mean=1,sd=0.2/sqrt(36)) )
@
       \item This question is about individuals; thus, the population distribution, which is known to be normal, should be used.  The most common 95\% of Wr values are between \Sexpr{formatC(distrib(0.025,mean=1,sd=0.2,type="q",plot=FALSE),format="f",digits=2)} and \Sexpr{formatC(distrib(0.975,mean=1,sd=0.2,type="q",plot=FALSE),format="f",digits=2)}, as computed with
<<par1a=TRUE>>=
( distrib(0.025,mean=1,sd=0.2,type="q") )
( distrib(0.975,mean=1,sd=0.2,type="q") )
@
       \item This question is about a statistic; thus, the sampling distribution, as identified previously, should be used.   The most common 90\% of mean Wr values in samples of $n=36$ are between \Sexpr{formatC(distrib(0.05,mean=1,sd=0.2/sqrt(36),type="q",plot=FALSE),format="f",digits=3)} and \Sexpr{formatC(distrib(0.95,mean=1,sd=0.2/sqrt(36),type="q",plot=FALSE),format="f",digits=3)}, as computed with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:CLTRocky}{\ref{revex:CLTRocky}} --
    \begin{enumerate}
       ...
       \item This question is about a statistic and requires the sampling distribution.  The sampling distribution of  $\bar{x}\sim N(8,\frac{2}{\sqrt{25}})$ because $n=25 \geq 15$ and the population distribution is not strongly skewed.  Thus, the probability is \Sexpr{formatC(distrib(10,mean=8,sd=2/sqrt(25),lower.tail=FALSE,plot=FALSE),digits=4,format="f")}, as computed with
<<par1a=TRUE>>=
( distrib(10,mean=8,sd=2/sqrt(25),lower.tail=FALSE) ) 
@
       \item This question is ultimately about a statistic as the total of 510 should be converted an $\bar{x}$ of $\frac{510}{60}=8.5$ kg.  The sampling distribution of $\bar{x}\sim N(8,\frac{2}{\sqrt{60}})$ or $\bar{x}\sim N(8,0.2582)$ because $n=60 \geq 30$.  Thus, the probability is \Sexpr{formatC(distrib(8.5,mean=8,sd=2/sqrt(60),lower.tail=FALSE,plot=FALSE),digits=4,format="f")}, as computed with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:CLTFootballRB}{\ref{revex:CLTFootballRB}} --
    \begin{enumerate}
       ...
       \item This question is about a statistic and requires the sampling distribution.  The sampling distribution of $\bar{x}\sim N(82,\frac{26}{\sqrt{16}})$ because $n=16 \geq 15$ and the population distribution is not strongly skewed.  Thus, the probability is \Sexpr{formatC(distrib(100,mean=82,sd=26/sqrt(16),lower.tail=FALSE,plot=FALSE),digits=4,format="f")}, as computed with
<<par1a=TRUE>>=
( distrib(100,mean=82,sd=26/sqrt(16),lower.tail=FALSE) )
@
       \item This question is about a statistic and requires the same sampling distribution as the previous question --  $\bar{x}\sim N(82,\frac{26}{\sqrt{16}})$..  Thus, the probability is \Sexpr{formatC(distrib(90,mean=82,sd=26/sqrt(16),plot=FALSE)-distrib(70,mean=82,sd=26/sqrt(16),plot=FALSE),digits=4,format="f")}, as computed with
<<par1a=TRUE>>=
ab <- distrib(90,mean=82,sd=26/sqrt(16))
a <- distrib(70,mean=82,sd=26/sqrt(16))
ab-a
@
       \item This question is about a statistic and requires the sampling distribution.  The sampling distribution of $\bar{x}\sim N(82,\frac{26}{\sqrt{32}})$ because $n=32 \geq 30$.  Thus, the probability is \Sexpr{formatC(distrib(70,mean=82,sd=26/sqrt(32),lower.tail=FALSE,plot=FALSE),digits=4,format="f")}, as computed with
<<par1a=TRUE>>=
( distrib(70,mean=82,sd=26/sqrt(32),lower.tail=FALSE) )
@
       \item This question is about an individual (a game) and requires the population distribution. It CANNOT BE COMPUTED because the population distribution is not normally distributed.
       \item This question is about a statistic and requires the sampling distribution.  The sampling distribution of $\bar{x}\sim N(82,\frac{26}{\sqrt{16}})$ because $n=16 \geq 15$ and the population distribution is not strongly skewed.  Thus, the mean yards gained is \Sexpr{formatC(distrib(0.05,mean=82,sd=26/sqrt(16),type="q",lower.tail=FALSE,plot=FALSE),digits=1,format="f")}, as computed with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:CLTStocks}{\ref{revex:CLTStocks}} --
    \begin{enumerate}
       \item This question is about a statistic and requires the sampling distribution.  The sampling distribution of $\bar{x}\sim N(4.2,\frac{4.9}{\sqrt{5}})$ because the population distribution is approximately normal.  Thus, the probability is \Sexpr{formatC(distrib(0,mean=4.2,sd=4.9/sqrt(5),lower.tail=FALSE,plot=FALSE),digits=4,format="f")}, as computed with
<<par1a=TRUE>>=
( distrib(0,mean=4.2,sd=4.9/sqrt(5),lower.tail=FALSE) )
@
       \item This question is about an individual (a stock) and requires the population distribution. Because the population distribution is approximately normally distributed, the probability can be computed.  Thus, the probability is \Sexpr{formatC(distrib(0,mean=4.2,sd=4.9,plot=FALSE,lower.tail=FALSE),digits=4,format="f")}, as computed with
<<par1a=TRUE>>=
( distrib(0,mean=4.2,sd=4.9,lower.tail=FALSE) )
@
       \item This question is about a statistic and requires the sampling distribution.  The sampling distribution of $\bar{x}\sim N(4.2,\frac{4.9}{\sqrt{10}})$ because the population distribution is approximately normal.  Thus, the probability is \Sexpr{formatC(distrib(2,mean=4.2,sd=4.9/sqrt(10),plot=FALSE),digits=4,format="f")}, as computed with
<<par1a=TRUE>>=
( distrib(2,mean=4.2,sd=4.9/sqrt(10)) )
@
       \item This question is about an individual (a stock) and requires the population distribution. Because the population distribution is approximately normally distributed, the probability can be computed.  Thus, the mean return is \Sexpr{formatC(distrib(0.10,mean=4.2,sd=4.9,plot=FALSE,type="q",lower.tail=FALSE),digits=1,format="f")}, as computed with
<<par1a=TRUE>>=
( distrib(0.10,mean=4.2,sd=4.9,type="q",lower.tail=FALSE) )
@
       \item This question is about a statistic and requires the sampling distribution.  The sampling distribution of $\bar{x}\sim N(4.2,\frac{4.9}{\sqrt{10}})$ because the population distribution is approximately normal.  Thus, the mean return is \Sexpr{formatC(distrib(0.10,mean=4.2,sd=4.9/sqrt(10),type="q",lower.tail=FALSE,plot=FALSE),digits=1,format="f")}, as computed with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:CLTHoney}{\ref{revex:CLTHoney}} --
    \begin{enumerate}
       ...
       \item This question is about a statistic and requires the sampling distribution.  The sampling distribution of $\bar{x}\sim N(9.5,\frac{13.5}{\sqrt{50}})$ because $n \geq 30$.  Thus, the probability is \Sexpr{formatC(distrib(10,mean=9.5,sd=13.5/sqrt(50),plot=FALSE),digits=4,format="f")}, as computed with
<<par1a=TRUE>>=
( distrib(10,mean=9.5,sd=13.5/sqrt(50)) )
@
       \item This question is about a statistic and requires the same sampling distribution as in the previous question -- $\bar{x}\sim N(9.5,\frac{13.5}{\sqrt{50}})$.  Thus, the average amount is \Sexpr{formatC(distrib(0.20,mean=9.5,sd=13.5/sqrt(50),type="q",plot=FALSE),digits=1,format="f")}, as computed with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:CLTFarms}{\ref{revex:CLTFarms}} --
    \begin{enumerate}
       ...
       \item This question is about a statistic and requires the sampling distribution.  The sampling distribution of $\bar{x}\sim N(65.13,\frac{108.71}{\sqrt{60}})$ because $n \geq 30$.  Thus, the most common 10\% of means is between \Sexpr{formatC(distrib(0.45,mean=65.13,sd=108.71/sqrt(60),type="q",plot=FALSE),digits=2,format="f")} and \Sexpr{formatC(distrib(0.55,mean=65.13,sd=108.71/sqrt(60),type="q",plot=FALSE),digits=2,format="f")}, as computed with
<<par1a=TRUE>>=
( distrib(0.45,mean=65.13,sd=108.71/sqrt(60),type="q") )
( distrib(0.55,mean=65.13,sd=108.71/sqrt(60),type="q") )
@
       \item This question is about a statistic and requires the same sampling distribution as in the previous question -- $\bar{x}\sim N(65.13,\frac{108.71}{\sqrt{60}})$.  Thus, the probability is \Sexpr{formatC(distrib(50,mean=65.13,sd=108.71/sqrt(60),plot=FALSE),digits=4,format="f")}, as computed with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:CLTTurtles}{\ref{revex:CLTTurtles}} --
    \begin{enumerate}
       ...
       \item This question is about a statistic and requires the sampling distribution.  The sampling distribution of $\bar{x}\sim N(4.46,\frac{0.13}{\sqrt{20}})$ because $n \geq 15$ and the population is only slightly skewed.  Thus, the probability that a sample of 20 turtles will have an average number of days until hatching that is greater than 4.5 days is \Sexpr{formatC(distrib(4.5,mean=4.46,sd=0.13/sqrt(20),lower.tail=FALSE,plot=FALSE),digits=4,format="f")}, as computed with
<<par1a=TRUE>>=
( distrib(4.5,mean=4.46,sd=0.13/sqrt(20),lower.tail=FALSE) )
@
       \item This question is about a statistic and requires the sampling distribution.  The sampling distribution of $\bar{x}\sim N(4.46,\frac{0.13}{\sqrt{50}})$ because $n \geq 30$.  Thus, the probability that a sample of 50 turtles will have an average number of days until hatching that is greater than 4.5 days is \Sexpr{formatC(distrib(4.5,mean=4.46,sd=0.13/sqrt(50),lower.tail=FALSE,plot=FALSE),digits=4,format="f")}, as computed with
<<par1a=TRUE>>=
( distrib(4.5,mean=4.46,sd=0.13/sqrt(50),lower.tail=FALSE) )
@
       \item This question is about a statistic and requires the same sampling distribution as in the previous question -- $\bar{x}\sim N(4.46,\frac{0.13}{\sqrt{50}})$.  Thus, the mean number of days until hatching such that 20\% of samples of 50 turtles have a smaller mean is \Sexpr{formatC(distrib(0.20,mean=4.46,sd=0.13/sqrt(50),type="q",plot=FALSE),digits=2,format="f")}, as computed with
<<par1a=TRUE>>=
...
\begin{itemize}  
  ...
  \item \hypertarget{ans:HypTCalc1}{\ref{revex:HypTCalc1}} -- The p-value is \Sexpr{kPvalue(distrib(12.1,mean=10,sd=5/sqrt(25),lower.tail=FALSE,plot=FALSE))}, reject $H_{O}$.  The p-value was computed with
<<HypTCalc1, fig.width=3.5, fig.height=3.5, par1a=TRUE>>=
( distrib(12.1,mean=10,sd=5/sqrt(25),lower.tail=FALSE) )
@  
  \item \hypertarget{ans:HypTCalc2}{\ref{revex:HypTCalc2}} -- The p-value is \Sexpr{kPvalue(distrib(43.8,mean=50,sd=20/sqrt(50),lower.tail=TRUE,plot=FALSE))}, reject $H_{O}$.  The p-value was computed with
<<HypTCalc2, fig.width=3.5, fig.height=3.5, par1a=TRUE>>=
( distrib(43.8,mean=50,sd=20/sqrt(50),lower.tail=TRUE) )
@  
  \item \hypertarget{ans:HypTCalc3}{\ref{revex:HypTCalc3}} -- The p-value is \Sexpr{kPvalue(2*distrib(98,mean=100,sd=15/sqrt(100),lower.tail=TRUE,plot=FALSE))}, DNR $H_{O}$.  The p-value was computed with
<<HypTCalc3, fig.width=3.5, fig.height=3.5, par1a=TRUE>>=
...
@  
  ...
  \item \hypertarget{ans:HypTEffluent}{\ref{revex:HypTEffluent}} --
    \begin{enumerate}
      ...
      \item The p-value is \Sexpr{kPvalue(distrib(2504,mean=2200,sd=1200/sqrt(118),lower.tail=FALSE,plot=FALSE))} as computed with
<<par1a=TRUE>>=
...
@ 
  ...
  \item \hypertarget{ans:HypTMedSchool}{\ref{revex:HypTMedSchool}} --
    \begin{enumerate}
      ...
      \item The p-value is \Sexpr{kPvalue(distrib(3.6,mean=3.7,sd=0.35/sqrt(40),plot=FALSE))} as computed with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:CI99zstar}{\ref{revex:CI99zstar}} $Z^{*}$=$\pm$\Sexpr{formatC(distrib(0.01/2,type="q",lower.tail=FALSE,plot=FALSE),format="f",digits=3)} as computed with
<<par1a=TRUE>>=
( distrib(0.01/2,type="q",lower.tail=FALSE) )
@
  \item \hypertarget{ans:CI92zstar}{\ref{revex:CI92zstar}} $Z^{*}$=\Sexpr{formatC(distrib(0.92,type="q",lower.tail=FALSE,plot=FALSE),format="f",digits=3)} as computed with
<<par1a=TRUE>>=
( distrib(0.92,type="q",lower.tail=FALSE) )
@
  \item \hypertarget{ans:CI90zstar}{\ref{revex:CI90zstar}} $Z^{*}$=\Sexpr{formatC(distrib(0.9,type="q",plot=FALSE),format="f",digits=3)} as computed with
<<par1a=TRUE>>=
( distrib(0.9,type="q") )
@
  \item \hypertarget{ans:CI98zstar}{\ref{revex:CI98zstar}} $Z^{*}$=$\pm$\Sexpr{formatC(distrib(0.02/2,type="q",lower.tail=FALSE,plot=FALSE),format="f",digits=3)} as computed with
<<par1a=TRUE>>=
( distrib(0.02/2,type="q",lower.tail=FALSE) )
@
  \item \hypertarget{ans:CI95zstar}{\ref{revex:CI95zstar}} $Z^{*}$=\Sexpr{formatC(distrib(0.95,type="q",lower.tail=FALSE,plot=FALSE),format="f",digits=3)} as computed with
<<par1a=TRUE>>=
( distrib(0.95,type="q",lower.tail=FALSE) )
@
  \item \hypertarget{ans:CI70zstar}{\ref{revex:CI70zstar}} $Z^{*}$=\Sexpr{formatC(distrib(0.70,type="q",plot=FALSE),format="f",digits=3)} as computed with
<<par1a=TRUE>>=
( distrib(0.70,type="q") )
@
  \item \hypertarget{ans:CIEffluent}{\ref{revex:CIEffluent}} -- 
<<echo=FALSE, results='hide'>>=
zstar <- distrib(0.90,type="q",lower.tail=FALSE,plot=FALSE)
se <- 1200/sqrt(118)
me <- zstar*se
cb <- 2504+me
@   
Note that $\bar{x}=2504$, the $SE_{\bar{x}}$=$\frac{1200}{\sqrt(118)}$=\Sexpr{formatC(se,format="f",digits=1)}, and $Z^{*}$=\Sexpr{formatC(zstar,format="f",digits=3)} as computed with
<<par1a=TRUE>>=
( distrib(0.90,type="q",lower.tail=FALSE) )
@  
Thus, a 90\% lower bound is 2504\Sexpr{formatC(zstar,format="f",digits=3)}*\Sexpr{formatC(se,format="f",digits=1)}, 2504\Sexpr{formatC(me,format="f",digits=1)}, or \Sexpr{formatC(cb,format="f",digits=1)}.  Thus, one is 90\% confident that the BOD in the effluent is greater than \Sexpr{formatC(cb,format="f",digits=1)}.
  \item \hypertarget{ans:CIMedSchool}{\ref{revex:CIMedSchool}} -- 
<<echo=FALSE, results='hide'>>=
zstar <- distrib(0.95,type="q",plot=FALSE)
mn <- 3.60
se <- 0.35/sqrt(40)
me <- zstar*se
cb <- mn+me
@   
Note that $\bar{x}=$\Sexpr{formatC(mn,format="f",digits=2)}, the $SE_{\bar{x}}$=$\frac{125}{\sqrt(15)}$=\Sexpr{formatC(se,format="f",digits=2)}, and $Z^{*}=$\Sexpr{formatC(zstar,format="f",digits=3)} as computed with
<<par1a=TRUE>>=
( distrib(0.95,type="q") )
@ 
Thus, a 95\% upper confidence bound is \Sexpr{formatC(mn,format="f",digits=2)}\Sexpr{formatC(zstar,format="f",digits=3)}*\Sexpr{formatC(se,format="f",digits=2)}, \Sexpr{formatC(mn,format="f",digits=2)}\Sexpr{formatC(me,format="f",digits=2)}, or \Sexpr{formatC(cb,format="f",digits=2)}.  Thus, one is 95\% confident that the mean gpa in non-science courses for all applicants was less than \Sexpr{formatC(cb,format="f",digits=2)}.
  \item \hypertarget{ans:CIBrule}{\ref{revex:CIBrule}} --
<<echo=FALSE, results='hide'>>=
zstar <- distrib(0.05/2,type="q",lower.tail=FALSE,plot=FALSE)
mn <- 1.725
se <- 0.2/sqrt(16)
me <- zstar*se
cb1 <- mn-me
cb2 <- mn+me
@   
Note that $\bar{x}=$\Sexpr{formatC(mn,format="f",digits=3)}, the $SE_{\bar{x}}$=$\frac{0.2}{\sqrt(16)}$=\Sexpr{formatC(se,format="f",digits=3)}, and $Z^{*}=\pm$\Sexpr{formatC(zstar,format="f",digits=3)} as computed with
<<par1a=TRUE>>=
( distrib(0.05/2,type="q",lower.tail=FALSE) )
@ 
Thus, a 95\% confidence interval is \Sexpr{formatC(mn,format="f",digits=3)}$\pm$\Sexpr{formatC(zstar,format="f",digits=3)}*\Sexpr{formatC(se,format="f",digits=3)}, \Sexpr{formatC(mn,format="f",digits=3)}$\pm$\Sexpr{formatC(me,format="f",digits=3)}, or (\Sexpr{formatC(cb1,format="f",digits=3)},\Sexpr{formatC(cb2,format="f",digits=3)}).  Thus, one is 95\% confident that the mean gage height for the Brule River is between \Sexpr{formatC(cb1,format="f",digits=3)} and \Sexpr{formatC(cb2,format="f",digits=3)}.
  \item \hypertarget{ans:CIWIc}{\ref{revex:CIWIc}} --
<<echo=FALSE, results='hide'>>=
zstar <- distrib(0.90,type="q",plot=FALSE)
mn <- 92.86
se <- 125/sqrt(15)
me <- zstar*se
cb <- mn+me
...
( distrib(0.90,type="q") )
@ 
Thus, a 90\% upper confidence bound is \Sexpr{formatC(mn,format="f",digits=2)}\Sexpr{formatC(zstar,format="f",digits=3)}*\Sexpr{formatC(se,format="f",digits=2)}, \Sexpr{formatC(mn,format="f",digits=2)}\Sexpr{formatC(me,format="f",digits=2)}, or \Sexpr{formatC(cb,format="f",digits=2)}.  Thus, one is 90\% confident that the mean population density for all counties is less than \Sexpr{formatC(cb,format="f",digits=2)} people/land acre.
  \item \hypertarget{ans:CICreatPhosph}{\ref{revex:CICreatPhosph}} --
<<echo=FALSE, results='hide'>>=
zstar <- distrib(0.95,type="q",lower.tail=FALSE,plot=FALSE)
mn <- 98.28
se <- 40/sqrt(36)
me <- zstar*se
cb <- mn+me
@   
Note that $\bar{x}=$\Sexpr{formatC(mn,format="f",digits=2)}, the $SE_{\bar{x}}$=$\frac{40}{\sqrt(36)}$=\Sexpr{formatC(se,format="f",digits=2)}, and $Z^{*}=$\Sexpr{formatC(zstar,format="f",digits=3)} as computed with
<<par1a=TRUE>>=
( distrib(0.95,type="q",lower.tail=FALSE) )
@ 
Thus, a 95\% lower confidence bound is \Sexpr{formatC(mn,format="f",digits=2)}\Sexpr{formatC(zstar,format="f",digits=3)}*\Sexpr{formatC(se,format="f",digits=2)}, \Sexpr{formatC(mn,format="f",digits=2)}\Sexpr{formatC(me,format="f",digits=2)}, or \Sexpr{formatC(cb,format="f",digits=2)}.  Thus, one is 95\% confident that the mean creatine phosphokinase level in all male volunteers is greater than \Sexpr{formatC(cb,format="f",digits=2)} International Units per liter.
...
@
<<echo=FALSE, results='hide'>>=
zstar <- distrib(0.01/2,type="q",lower.tail=FALSE,plot=FALSE)
mn <- mean(snow)
se <- 15/sqrt(length(snow))
me <- zstar*se
cb1 <- mn-me
cb2 <- mn+me
@
Note that $\bar{x}=$\Sexpr{formatC(mn,format="f",digits=2)}, the $SE_{\bar{x}}$=$\frac{15}{\sqrt(15)}$=\Sexpr{formatC(se,format="f",digits=2)}, and $Z^{*}=\pm$\Sexpr{formatC(zstar,format="f",digits=3)} as computed with
<<par1a=TRUE>>=
( distrib(0.01/2,type="q",lower.tail=FALSE) )
@ 
Thus, a 99\% confidence interval is \Sexpr{formatC(mn,format="f",digits=2)}$\pm$\Sexpr{formatC(zstar,format="f",digits=3)}*\Sexpr{formatC(se,format="f",digits=2)}, \Sexpr{formatC(mn,format="f",digits=2)}$\pm$\Sexpr{formatC(me,format="f",digits=2)}, or (\Sexpr{formatC(cb1,format="f",digits=2)},\Sexpr{formatC(cb2,format="f",digits=2)}).  Thus, one is 99\% confident that the mean snow pack height for all days is between \Sexpr{formatC(cb1,format="f",digits=2)} and \Sexpr{formatC(cb2,format="f",digits=2)} cm.  This interval is probably inappropriate because the sample size is not large enough given the strong right-skew and outlier of the population distribution.
  ...
  \item \hypertarget{ans:HypTestZCactus}{\ref{revex:HypTestZCactus}} --
    \begin{enumerate}
      ...
      \item The p-value is \Sexpr{kPvalue(distrib(3.26,mean=4,sd=1.40/sqrt(10),plot=FALSE))} as computed with
<<par1a=TRUE>>=
...
@
      ...
      \item A 95\% upper confidence bound is warranted in this situation and will use a $Z^{*}=$\Sexpr{formatC(distrib(0.95,type="q",plot=FALSE),format="f",digits=3)}, as computed with
<<par1a=TRUE>>=
( distrib(0.95,type="q") )
@
Thus, $3.26+1.645*0.44$ or $3.26+0.72$ = $3.98$.  Thus, one is 95\% confident that the mean growth of all cacti under the experimental conditions is less than 3.98 cm.
  ...
  \item \hypertarget{ans:HypTestZPike}{\ref{revex:HypTestZPike}} --
    \begin{enumerate}
      ...
      \item The p-value is \Sexpr{kPvalue(2*distrib(656.1,mean=600,sd=130/sqrt(30),lower.tail=FALSE,plot=FALSE))} as computed with
<<par1a=TRUE>>=
...
@
      ...
      \item A 95\% confidence interval is warranted in this situation and will use a $Z^{*}=\pm$\Sexpr{formatC(distrib(0.05/2,type="q",lower.tail=FALSE,plot=FALSE),format="f",digits=3)}, as computed with
<<par1a=TRUE>>=
( distrib(0.05/2,type="q",lower.tail=FALSE) )
@
...
@
      \item The hypothesis is about $\mu$.  Therefore, we want to calculate $\bar{x}$, which from the output above, is \Sexpr{formatC(pain.z$estimate,format="f",digits=2)} years.
      \item The z test statistic is \Sexpr{formatC(pain.z$statistic,format="f",digits=2)}.
      \item The p-value for this value of the test statistic is \Sexpr{kPvalue(pain.z$p.value)}.
      \item Reject $H_{O}$ because the $p-value<\alpha$.
      \item It appears that the mean duration of pain for all patients may be longer than 2.5 years.
      \item A 90\% lower confidence bound is \Sexpr{formatC(pain.z$conf.int[1],format="f",digits=2)}.  One is 90\% confident that the mean duration of pain for all patients is more than \Sexpr{formatC(pain.z$conf.int[1],format="f",digits=2)} years.
    \end{enumerate}
...
str(ch)
@
      \item $n=$\Sexpr{length(ch$cholest)} $>30$ and $\sigma$ is known.  As the assumptions have been met the Z-test was performed with
<<>>=
( ch.z <- z.test(ch$cholest,mu=190,sd=40,conf.level=0.90) )
@
      \item The hypothesis is about $\mu$.  Therefore, we want to calculate $\bar{x}$, which from the output above, is \Sexpr{formatC(ch.z$estimate,format="f",digits=2)} years.
      \item The z test statistic is \Sexpr{formatC(ch.z$statistic,format="f",digits=2)}.
      \item The p-value for this value of the test statistic is \Sexpr{kPvalue(ch.z$p.value)}.
...
\section*{t Tests}
\begin{itemize}  
  \item \hypertarget{ans:tTestpv1}{\ref{revex:tTestpv1}} -- The p-value is \Sexpr{kPvalue(distrib(-2.178,distrib="t",df=35,lower.tail=TRUE))} as computed with
<<par1a=TRUE>>=
( distrib(-2.178,distrib="t",df=35,lower.tail=TRUE) )
@
  \item \hypertarget{ans:tTestci1}{\ref{revex:tTestci1}} -- The 95\% upper confidence bound would use a $t^{*}$ of \Sexpr{formatC(distrib(0.95,distrib="t",type="q",df=35,lower.tail=TRUE,plot=FALSE),format="f",digits=3)} as computed with
<<par1a=TRUE>>=
( distrib(0.95,distrib="t",type="q",df=35,lower.tail=TRUE) )
@
  \item \hypertarget{ans:tTestpv2}{\ref{revex:tTestpv2}} -- The p-value is \Sexpr{kPvalue(distrib(1.856,distrib="t",df=81,lower.tail=FALSE))} as computed with
<<par1a=TRUE>>=
( distrib(1.856,distrib="t",df=81,lower.tail=FALSE) )
@ 
  \item \hypertarget{ans:tTestci2}{\ref{revex:tTestci2}} -- THe 99\% lower confidence bound would use a $t^{*}$ of \Sexpr{formatC(distrib(0.9,distrib="t",type="q",df=81,lower.tail=FALSE),format="f",digits=3)} as computed with
<<par1a=TRUE>>=
( distrib(0.99,distrib="t",type="q",df=81,lower.tail=FALSE) )
@
  \item \hypertarget{ans:tTestpv3}{\ref{revex:tTestpv3}} -- The p-value is \Sexpr{kPvalue(2*distrib(-2.178,distrib="t",df=99,lower.tail=TRUE))} as compute with
<<par1a=TRUE>>=
( 2*distrib(-2.178,distrib="t",df=99,lower.tail=TRUE) )
@
  \item \hypertarget{ans:tTestci3}{\ref{revex:tTestci3}} -- The 90\% confidence interval would use a $t^{*}$ of $\pm$\Sexpr{formatC(distrib(0.05,distrib="t",type="q",df=99,lower.tail=FALSE,plot=FALSE),format="f",digits=3)}
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:tTestSuperInt}{\ref{revex:tTestSuperInt}} --
    \begin{enumerate}
      ...
      \item The p-value is \Sexpr{kPvalue(pt(3.29,df=31,lower.tail=FALSE))} as calculated with
<<par1a=TRUE>>=
...
@
      ...
      \item A 95\% lower confidence bound is warranted in this situation.  The $t^{*}=$\Sexpr{formatC(qt(0.95,df=31,lower.tail=FALSE),format="f",digits=3)} as computed with
<<par1a=TRUE>>=
...
Thus, $83.2-1.696\frac{5.5}{\sqrt{32}}$ or $83.2-1.65$=$81.455$.  One is 95\% confident that the mean achievement score for all students at the superintendent's school is greater than 81.46 points.
  ...
  \item \hypertarget{ans:tTestLASalary}{\ref{revex:tTestLASalary}} --
    \begin{enumerate}
      ...
      \item The p-value is \Sexpr{kPvalue(pt(1.933251,df=41,lower.tail=FALSE))} as calculated with
<<par1a=TRUE>>=
...
@
      ...
      \item A 90\% lower confidence bound is warranted in this situation.  The $t^{*}=$\Sexpr{formatC(qt(0.90,df=41,lower.tail=FALSE),format="f",digits=3)} as computed with
<<par1a=TRUE>>=
...
@
      \item The $\sigma$ is unknown.  The sample size (=\Sexpr{length(fl)}) is not greater than 40, however, it is greater than 15.  The histogram \figrefp{fig:FishingLineHist} suggests that the sample distribution is roughly symmetric.  Thus, the assumptions are adequately met and the sampling distribution of the test statistic should follow a t-distribution.
<<FishingLineHist, fig.width=3.5, fig.height=3.5, fig.cap="Histogram of fishing line break weights.", par1=TRUE>>=
...
@
      \item The statistic is $\bar{x}=$\Sexpr{formatC(fl.t$estimate,format="f",digits=2)}.
      \item The test statistic is $t=$\Sexpr{formatC(fl.t$statistic,format="f",digits=3)} with \Sexpr{fl.t$parameter} df.
      \item The p-value is \Sexpr{kPvalue(fl.t$p.value)}.
      \item The $H_{O}$ is not rejected because the $p-value>\alpha$.
...
str(sb)
@
      \item The $\sigma$ is unknown.  The sample size (=\Sexpr{length(sb$berries)}) is greater than 40.  Thus, the sampling distribution of the test statistic should follow a t-distribution.  The results of the t-test were then computed with
<<>>=
( sb.t <- t.test(sb$berries,mu=12,alt="less",conf.level=0.90) )
@
      \item The statistic is $\bar{x}$=\Sexpr{formatC(sb.t$estimate,format="f",digits=2)}.
      \item The test statistic is $t=$\Sexpr{formatC(sb.t$statistic,format="f",digits=3)} with \Sexpr{sb.t$parameter} df.
      \item The p-value is \Sexpr{kPvalue(sb.t$p.value)}.
      ...
      \item A 90\% upper confidence bound is \Sexpr{formatC(sb.t$conf.int[2],format="f",digits=2)}.  Thus, one is 90\% confident that the mean number of berries produces is less than \Sexpr{formatC(sb.t$conf.int[2],format="f",digits=2)}.
    \end{enumerate}
...
str(tt)
@
      \item The $\sigma$ is unknown.  The sample size (=\Sexpr{length(tt$time)}) is not greater than 40, however it is greater than 15.  The histogram \figrefp{fig:ToyTimeHist} suggests that the sample distribution is roughly symmetric.  Thus, the assumptions are adequately met and the sampling distribution of the test statistic should follow a t-distribution.  
<<ToyTimeHist, fig.width=3.5, fig.height=3.5, fig.cap="Histogram of time to assemble toy.", par1=TRUE>>=
...
@
      \item The statistic is $\bar{x}=$\Sexpr{formatC(tt.t$estimate,format="f",digits=2)}.
      \item The test statistic is $t=$\Sexpr{formatC(tt.t$statistic,format="f",digits=3)} with \Sexpr{tt.t$parameter} df.
      \item The p-value is \Sexpr{kPvalue(tt.t$p.value)}.
      \item The $H_{O}$ is not rejected because the $p-value>\alpha$.
...
@
      \item The $\sigma$ is unknown.  The sample size (=\Sexpr{dim(y1)[1]}) is greater than 40.  Thus, the assumptions are met and the sampling distribution of the test statistic should follow a t-distribution.  The results of the t-test were then computed with
<<>>=
( y.t <- t.test(y$boats.total,mu=75,alt="greater",conf.level=0.95) )
@
      \item The statistic is $\bar{x}$=\Sexpr{formatC(y.t$estimate,format="f",digits=2)}.
      \item The test statistic is $t=$\Sexpr{formatC(y.t$statistic,format="f",digits=3)} with \Sexpr{y.t$parameter} df.
      \item The p-value is \Sexpr{kPvalue(y.t$p.value)}.
      \item The $H_{O}$ is rejected because the $p-value<\alpha$.
      ...
      \item In fact, one is 95\% confident that the average number of boats through the locks per day during June, July, and August of 2005 is at least \Sexpr{formatC(y.t$conf.int[1],format="f",digits=2)}.
    \end{enumerate}
...
str(d)
@
      \item The $\sigma$ is unknown.  The sample size (=\Sexpr{dim(d)[1]}) is greater than 15 and the sample distribution is somewhat right-skewed with minor outliers \figrefp{fig:BeadsHist}.  The assumptions are marginally met and the sampling distribution of the test statistic will likely follow a t-distribution.
<<BeadsHist, fig.width=3.5, fig.height=3.5, fig.cap="Histogram of the width-to-length ratio of Shoshoni beads.", par1=TRUE>>=
...
@
      \item The statistic is $\bar{x}$=\Sexpr{formatC(d.t$estimate,format="f",digits=2)}.
      \item The test statistic is $t=$\Sexpr{formatC(d.t$statistic,format="f",digits=3)} with \Sexpr{d.t$parameter} df.
      \item The p-value is \Sexpr{kPvalue(d.t$p.value)}.
      \item The $H_{O}$ is not rejected because the $p-value>\alpha$.
  ...
  \item \hypertarget{ans:tTestPopcorn}{\ref{revex:tTestPopcorn}} --
    \begin{enumerate}
      ...
      \item The p-value is \Sexpr{kPvalue(2*pt(0.60,df=58,lower.tail=FALSE))} as calculated with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:tTestHeatVent}{\ref{revex:tTestHeatVent}} --
    \begin{enumerate}
      ...
      \item The p-value is \Sexpr{kPvalue(2*pt(0.384,df=88,lower.tail=FALSE))} as calculated with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:tTestPigBFT}{\ref{revex:tTestPigBFT}} --
    \begin{enumerate}
      ...
      \item The p-value is \Sexpr{kPvalue(2*pt(3.13,df=22,lower.tail=FALSE))} as calculated with
<<par1a=TRUE>>=
...
@
      ...
      \item A 95\% confidence interval is warranted in this situation with a $t^{*}$ of $\pm$\Sexpr{formatC(qt(0.025,df=22,lower.tail=FALSE),format="f",digits=3)} as computed with
<<par1a=TRUE>>=
...
view(mc)
@
      \item The populations are independent (cartons could not be both linead and unlined).  The sample size ($n_{L}+n_{UL}$=\Sexpr{dim(mc)[1]}) is $>40$.  Therefore, the test statistic computed below should reasonably follow a t-distribution with $n_{L}+n_{UL}-2$ = \Sexpr{dim(mc)[1]}-2 = \Sexpr{dim(mc)[1]-2} df.  The variances appear to be UNequal because the Levene's test p-value (\Sexpr{kPvalue(leveneTest(dioxin~type,data=mc)[1,"Pr(>F)"])}) is larger than $\alpha$.  The Levene's test was computed with
<<>>=
...
@
      \item The statistic is $\bar{x}_{L}-\bar{x}_{UL}$ = \Sexpr{formatC(mc.t$estimate[1],format="f",digits=3)}-\Sexpr{formatC(mc.t$estimate[2],format="f",digits=3)} = \Sexpr{formatC(mc.t$estimate[1]-mc.t$estimate[2],format="f",digits=3)}. 
      \item The test statistic is $t$=\Sexpr{formatC(mc.t$statistic,format="f",digits=3)} with \Sexpr{formatC(mc.t$parameter,format="f",digits=0)} df.
      \item The p-value is \Sexpr{kPvalue(mc.t$p.value)}.
      ...
      \item A 99\% upper confidence bound is \Sexpr{formatC(mc.t$conf.int[2],format="f",digits=2)}.  One is 99\% confident that the mean dioxin levels is more than \Sexpr{formatC(-1*mc.t$conf.int[2],format="f",digits=2)} \textbf{more} in the unlined than in the lined cartons.
    \end{enumerate}
...
view(mg)
@
      \item The populations are independent (no classes consisted of all the same students).  The sample size ($n_{m}+n_{o}$=\Sexpr{dim(mg)[1]}) is $>40$.  Therefore, the test statistic computed below should reasonably follow a t-distribution with $n_{m}+n_{o}-2$ = \Sexpr{dim(mg)[1]}-2 = \Sexpr{dim(mg)[1]-2} df.  The population variances appear to be equal because the Levene's test p-value (\Sexpr{kPvalue(leveneTest(gpa~class.type,data=mg)[1,"Pr(>F)"])}) is larger than $\alpha$.  The Levene's test was computed with
<<>>=
...
@
      \item The statistic is $\bar{x}_{m}-\bar{x}_{o}$ = \Sexpr{formatC(mg.t$estimate[1],format="f",digits=3)}-\Sexpr{formatC(mg.t$estimate[1],format="f",digits=3)} = \Sexpr{formatC(mg.t$estimate[1]-mg.t$estimate[2],format="f",digits=3)}. 
      \item The test statistic is $t$=\Sexpr{formatC(mg.t$statistic,format="f",digits=3)} with \Sexpr{formatC(mg.t$parameter,format="f",digits=0)} df.
      \item The p-value is \Sexpr{kPvalue(mg.t$p.value)}.
      ...
      \item A 90\% upper confidence bound is \Sexpr{formatC(mg.t$conf.int[2],format="f",digits=3)}.  Thus, one is 90\% confident that the mean gpa of students in the math class is more than \Sexpr{formatC(-1*mg.t$conf.int[2],format="f",digits=3)} \textbf{lower} than the gpa of students in the other classes.
    \end{enumerate}
...
view(med)
@
      \item The populations are independent (all interns were not in both cities).  The sample size ($n_{1}+n_{2}$=\Sexpr{dim(med)[1]}) is $<40$ but $>15$.  Histograms constructed for both groups \figrefp{fig:MedInternHrsHist} suggested a right-skewness but not an overly strong skew (this is very difficult to ascertain because of the small sample size).
<<MedInternHrsHist, fig.width=7, fig.height=3.5, fig.cap="Histogram of hours worked by medical school interns in two cities.", par1=TRUE>>=
hist(hrs.worked~city,data=med,main="",xlab="Hours Worked")
@
      
Therefore, the test statistic computed below should reasonably follow a t-distribution with $n_{1}+n_{2}-2$ = \Sexpr{dim(med)[1]}-2 = \Sexpr{dim(med)[1]-2} df.  The population variances appear to be equal because the Levene's test p-value (\Sexpr{kPvalue(leveneTest(hrs.worked~city,data=med)[1,"Pr(>F)"])}) is larger than $\alpha$.  The Levene's test was computed with
<<>>=
...
@
      \item The statistic is $\bar{x}_{1}-\bar{x}_{2}$ = \Sexpr{formatC(med.t$estimate[1],format="f",digits=2)}-\Sexpr{formatC(med.t$estimate[1],format="f",digits=2)} = \Sexpr{formatC(med.t$estimate[1]-med.t$estimate[2],format="f",digits=2)}. 
      \item The test statistic is $t$=\Sexpr{formatC(med.t$statistic,format="f",digits=3)} with \Sexpr{formatC(med.t$parameter,format="f",digits=0)} df.
      \item The p-value is \Sexpr{kPvalue(med.t$p.value)}.
      \item The $H_{0}$ is rejected because the $p-value <\alpha=0.10$.
      \item It appears that interns in the second city work more hours, on average, than interns in the first city.
      \item A 90\% confidence interval is from \Sexpr{formatC(med.t$conf.int[1],format="f",digits=2)} to \Sexpr{formatC(med.t$conf.int[2],format="f",digits=2)}.  Thus, one is 90\% confident that the interns in the second city work between \Sexpr{formatC(-1*med.t$conf.int[2],format="f",digits=2)} and \Sexpr{formatC(-1*med.t$conf.int[1],format="f",digits=2)} hours more than interns in the first city.
    \end{enumerate}
  \item \hypertarget{ans:tTestYield}{\ref{revex:tTestYield}} --
<<echo=FALSE, results='hide'>>=
if ("group" %in% ls()) rm(group)
@
    \begin{enumerate}
      \item As stated, $\alpha$ should be set at 0.10.
...
view(yld)
@
      \item The populations are independent as there is no connection between the two types of plots.  The sample size ($n_{i}+n_{s}$=\Sexpr{dim(yld)[1]}) is $>40$.  Therefore, the test statistic computed below should reasonably follow a t-distribution with $n_{i}+n_{s}-2$ = \Sexpr{dim(yld)[1]}-2 = \Sexpr{dim(yld)[1]-2} df.  The variances appear to be equal because the Levene's test p-value (\Sexpr{kPvalue(leveneTest(yield~group,data=yld)[1,"Pr(>F)"])}) is larger than $\alpha$.  The Levene's test was computed with
<<>>=
...
@
      \item The statistic is $\bar{x}_{i}-\bar{x}_{s}$ = \Sexpr{formatC(yld.t$estimate[1],format="f",digits=3)}-\Sexpr{formatC(yld.t$estimate[1],format="f",digits=3)} = \Sexpr{formatC(yld.t$estimate[1]-yld.t$estimate[2],format="f",digits=3)}. 
      \item The test statistic is $t$=\Sexpr{formatC(yld.t$statistic,format="f",digits=3)} with \Sexpr{formatC(yld.t$parameter,format="f",digits=0)} df.
      \item The p-value is \Sexpr{kPvalue(yld.t$p.value)}
       \item The $H_{0}$ is rejected because the $p-value <\alpha=0.05$.
      ...
      \item A 90\% confidence interval is \Sexpr{formatC(yld.t$conf.int[1],format="f",digits=2)} to \Sexpr{formatC(yld.t$conf.int[2],format="f",digits=2)}.  Thus,one is 90\% confident that the mean yield in plots with sterile males is between \Sexpr{formatC(-1*yld.t$conf.int[2],format="f",digits=2)} and \Sexpr{formatC(-1*yld.t$conf.int[1],format="f",digits=2)} bushels \textbf{higher} than in plots with the insecticide.
    \end{enumerate}
...
str(d)
@
      \item The populations are independent because the individual cannot both be a donor and a non donor.  The sample size ($n_{o}+n_{n}$=\Sexpr{dim(d)[1]}) is $>40$.  Therefore, the test statistic computed below should reasonably follow a t-distribution with $n_{o}+n_{n}-2$ = \Sexpr{dim(d)[1]})-2 = \Sexpr{dim(d)[1]-2}) df.  The variances appear to be equal because the Levene's test p-value (\Sexpr{kPvalue(leveneTest(DAS~donor,data=d)[1,"Pr(>F)"])}) is larger than $\alpha$.  The Levene's test was computed with
<<>>=
...
@
      \item The statistic is $\bar{x}_{o}-\bar{x}_{n}$ = \Sexpr{formatC(d.t$estimate[1],format="f",digits=2)}-\Sexpr{formatC(d.t$estimate[2],format="f",digits=2)} = \Sexpr{formatC(d.t$estimate[1]-d.t$estimate[2],format="f",digits=2)}. 
      \item The test statistic is $t$=\Sexpr{formatC(d.t$statistic,format="f",digits=3)} with \Sexpr{formatC(d.t$parameter,format="f",digits=0)} df.
      \item The p-value is \Sexpr{kPvalue(d.t$p.value)}.
...
\begin{itemize}  
  \item \hypertarget{ans:ChiPVal1}{\ref{revex:ChiPVal1}} -- The p-value is \Sexpr{kPvalue(distrib(10.25,"chisq",df=3,lower.tail=FALSE,plot=FALSE))}, as computed with
<<par1a=TRUE>>=
( distrib(10.25,distrib="chisq",df=3,lower.tail=FALSE) )
@
  \item \hypertarget{ans:ChiPVal2}{\ref{revex:ChiPVal2}} -- The p-value is \Sexpr{kPvalue(distrib(10.25,"chisq",df=3,lower.tail=FALSE,plot=FALSE))}, as computed with
<<par1a=TRUE>>=
( distrib(10.25,distrib="chisq",df=4,lower.tail=FALSE) )
@
  \item \hypertarget{ans:ChiPVal3}{\ref{revex:ChiPVal3}} -- The p-value is \Sexpr{kPvalue(distrib(10.25,"chisq",df=3,lower.tail=FALSE,plot=FALSE))}, as computed with
<<par1a=TRUE>>=
  ...
  \item \hypertarget{ans:ChiGOFShrike}{\ref{revex:ChiGOFShrike}} --
    \begin{enumerate}
      ...
      \item The $\chi^{2}$ test statistic is thus,
        ...
        \end{center}
        with $4-1=3$ df.
      \item The p-value for this test statistic is \Sexpr{kPvalue(distrib(98.099,distrib="chisq",df=3,lower.tail=FALSE,plot=FALSE))}, as computed with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:ChiGOFClinton}{\ref{revex:ChiGOFClinton}} --
    \begin{enumerate}
      ...
      \item The p-value is \Sexpr{kPvalue(distrib(1.558,distrib="chisq",df=1,lower.tail=FALSE,plot=FALSE))}, as computed with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:ChiGOFPref2}{\ref{revex:ChiGOFPref2}} --
    ...
    \item The $\chi^{2}$ test statistic is thus,
      ...
      \end{center}
      with $3-1=2$ df.
    \item The p-value for this test statistic is \Sexpr{kPvalue(distrib(9.130,"chisq",df=2,lower.tail=FALSE,plot=FALSE))}, as computed with
<<par1a=TRUE>>=
...
where RY=``round, yellow'', RG=``round, green'', WY=``wrinkled, yellow'', and WG=``wrinkled, green''.      
      ...
      \item The $\chi^{2}$ test statistic is thus,
        ...
        \end{center}
        with $4-1=3$ df.
      \item The p-value for this test statistic is \Sexpr{kPvalue(distrib(1.709,"chisq",df=3,lower.tail=FALSE,plot=FALSE))}, as computed with
<<par1a=TRUE>>=
...
From this it is seen that each cell of the expected table has more than five individuals.  Thus, the test statistic below should follow a $\chi^{2}$ distribution.
      ...
      \item The $\chi^{2}$ test statistic is \Sexpr{formatC(pref.chi$statistic,format="f",digits=3)} with \Sexpr{pref.chi$parameter} df, as computed with
<<>>=
pref.chi
@
      \item The p-value for this test statistic is \Sexpr{kPvalue(pref.chi$p.value)}.
...
From this it is seen that each cell of the expected column/table has more than five individuals.  Thus, the test statistic below should follow a $\chi^{2}$ distribution.
      ...
      \item The $\chi^{2}$ test statistic is \Sexpr{formatC(om.chi$statistic,format="f",digits=3)} with \Sexpr{om.chi$parameter} df, as computed with
<<>>=
om.chi
@
      \item The p-value for this test statistic is \Sexpr{kPvalue(om.chi$p.value)}.
      \item The null hypothesis is rejected because the $p-value<\alpha$.
...
From this it is seen that each cell of the expected column/table has more than five individuals.
      ...
      \item The $\chi^{2}$ test statistic is \Sexpr{formatC(flips.chi$statistic,format="f",digits=3)} with \Sexpr{flips.chi$parameter} df, as computed with
<<>>=
flips.chi
@
      \item The p-value for this test statistic is \Sexpr{kPvalue(flips.chi$p.value)}.
      \item The $H_{O}$ is not rejected because the $p-value>\alpha$.
  ...
  \item \hypertarget{ans:ChiGOFCD}{\ref{revex:ChiGOFCD}} --
    \begin{enumerate}
      ...
      \item This is an experiment with random allocation of individuals (CDs to slots in the player).  The data were entered into R\footnote{It would have been much easier to enter these data into Excel, save as a tab-delimited text file, and then read into R with \R{read.table()}.} and a summary table was constructed with
<<>>=
...
From this it is seen that each cell of the expected column/table has more than five individuals.  Thus, the test statistic computed below should reasonably follow a $\chi^{2}$-distribution.
      ...
      \item The $\chi^{2}$ test statistic is \Sexpr{formatC(cd.chi$statistic,format="f",digits=3)} with \Sexpr{cd.chi$parameter} df, as computed with
<<>>=
cd.chi
@
      \item The p-value for this test statistic is \Sexpr{kPvalue(cd.chi$p.value)}.
      \item The $H_{O}$ is not rejected because the $p-value>\alpha$.
...
From this it is seen that each cell of the expected table has more than five individuals.  Thus, the test statistic below should follow a $\chi^{2}$ distribution.
      \item The observed frequency table is in the ``obs'' column in the results above.
      \item The $\chi^{2}$ test statistic is \Sexpr{formatC(bt.chi$statistic,format="f",digits=3)} with \Sexpr{bt.chi$parameter} df, as computed with
<<>>=
bt.chi
@
      \item The p-value for this test statistic is \Sexpr{kPvalue(bt.chi$p.value)}.
      \item The null hypothesis is rejected because the $p-value<\alpha$.
...
From this it is seen that each cell of the expected table has more than five individuals.  Thus the test statistic below should follow a $\chi^{2}$ distribution.
      \item The table of observed frequencies is shown in the ``obs'' column of the results above.
      \item The $\chi^{2}$ test statistic is \Sexpr{formatC(pc.chi$statistic,format="f",digits=3)} with \Sexpr{pc.chi$parameter} df, as computed with
<<>>=
pc.chi
@
      \item The p-value for this test statistic is \Sexpr{kPvalue(pc.chi$p.value)}.
      \item The $H_{O}$ is rejected because the $p-value<\alpha$.
...
@
Thus, one is 95\% confident that the proportion of supporters among the party constituents is between \Sexpr{formatC(gofCI(pc.chi)["support","p.LCI"],format="f",digits=3)} and \Sexpr{formatC(gofCI(pc.chi)["support","p.UCI"],format="f",digits=3)}.
    \end{enumerate}
...
@
      \item The expected frequency for the first group comes from solving for $X$ in $X+(0.5^{1}+0.5^{2}+0.5^{3}+0.5^{4}+0.5^{5})X =$\Sexpr{sum(da)} or $1.96875X=$\Sexpr{sum(da)} or $X=128.508$.  The remaining expected frequencies come from applying consecutive survival rates of 0.5 to the successive ages.  This is accomplished with
<<>>=
...
From this it is seen that each cell of the expected table does NOT contain more than five individuals\footnote{This is the genesis of the warning that is produced by R.}.  However, only one cell has a value less than five and that cell is only one individual short of the recommended value of five.  Thus, the test statistic below will likely reasonably follow a $\chi^{2}$ distribution.
      \item The observed frequency table is in the ``obs'' column in the results above.
      \item The $\chi^{2}$ test statistic is \Sexpr{formatC(da.chi$statistic,format="f",digits=3)} with \Sexpr{da.chi$parameter} df, as computed with
<<>>=
da.chi
@
      \item The p-value for this test statistic is \Sexpr{kPvalue(da.chi$p.value)}.
...
From this it is seen that each cell of the expected table has more than five individuals.  Thus the test statistic below should follow a $\chi^{2}$ distribution.
      \item The table of observed frequencies is shown in the ``obs'' column of the results above.
      \item The $\chi^{2}$ test statistic is \Sexpr{formatC(chi1$statistic,format="f",digits=3)} with \Sexpr{chi1$parameter} df, as computed with
<<>>=
chi1
@
      \item The p-value for this test statistic is \Sexpr{kPvalue(chi1$p.value)}.
      \item The $H_{O}$ is rejected because the $p-value<\alpha$.
...
@
Thus, one is 90\% confident that the proportion of king salmon in this catch is between \Sexpr{formatC(gofCI(chi1,conf.level=0.90)["kings","p.LCI"],format="f",digits=3)} and \Sexpr{formatC(gofCI(chi1,conf.level=0.90)["kings","p.UCI"],format="f",digits=3)}.
    \end{enumerate}
  ...
  \item \hypertarget{ans:ChiCyprin}{\ref{revex:ChiCyprin}} --
    \begin{enumerate}
      ...
      \item The p-value is \Sexpr{kPvalue(distrib(1.4615,"chisq",df=2,lower.tail=FALSE,plot=FALSE))}, as computed with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:ChiNurse}{\ref{revex:ChiNurse}} --
    \begin{enumerate}
      ...
      \item The p-value is \Sexpr{kPvalue(distrib(53.65584,"chisq",df=3,lower.tail=FALSE,plot=FALSE))}, as computed with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:ChiMI}{\ref{revex:ChiMI}} --
    \begin{enumerate}
      ...
      \item The p-value is \Sexpr{kPvalue(distrib(6.4635,"chisq",df=1,lower.tail=FALSE,plot=FALSE))}, as computed with
<<par1a=TRUE>>=
...
@
  ...
  \item \hypertarget{ans:ChiGreeting}{\ref{revex:ChiGreeting}} --
    \begin{enumerate}
      ...
      \item The p-value is \Sexpr{kPvalue(distrib(9.271,"chisq",df=2,lower.tail=FALSE,plot=FALSE))}, as computed with
<<par1a=TRUE>>=
...
@
      ...
      \item The $\chi^{2}$ test statistic is \Sexpr{formatC(rp.chi$statistic,format="f",digits=3)} with \Sexpr{rp.chi$parameter} df, as computed with
<<>>=
rp.chi
@
      \item The p-value for this test statistic is \Sexpr{kPvalue(rp.chi$p.value)}.
      \item The $H_{0}$ is rejected because the $p-value <\alpha$.
...
@
      \item The table of observed values is shown above in step 4.
      \item The $\chi^{2}$ test statistic is \Sexpr{formatC(au.chi$statistic,format="f",digits=3)} with \Sexpr{au.chi$parameter} df, as computed with
<<>>=
au.chi
@
      \item The p-value for this test statistic is \Sexpr{kPvalue(au.chi$p.value)}.
      \item The $H_{0}$ is rejected because the $p-value <\alpha$.
...
@
      \item The table of observed values is shown above in step 4.
      \item The $\chi^{2}$ test statistic is \Sexpr{formatC(med.chi$statistic,format="f",digits=3)} with \Sexpr{med.chi$parameter} df, as computed with
<<>>=
med.chi
@
      \item The p-value for this test statistic is \Sexpr{kPvalue(med.chi$p.value)}.
      \item The null hypothesis is rejected because the $p-value<\alpha$.
...
@
      \item The table of observed values is shown above in step 4.
      \item The $\chi^{2}$ test statistic is \Sexpr{formatC(ex.chi$statistic,format="f",digits=3)} with \Sexpr{ex.chi$parameter} df, as computed with
<<>>=
ex.chi
@
      \item The p-value for this test statistic is \Sexpr{kPvalue(ex.chi$p.value)}.
      \item The null hypothesis is rejected because the $p-value<\alpha$.
...
@
      ...
      \item The $\chi^{2}$ test statistic is \Sexpr{formatC(hpv.chi$statistic,format="f",digits=3)} with \Sexpr{hpv.chi$parameter} df, as computed with
<<>>=
hpv.chi
@
      \item The p-value for this test statistic is \Sexpr{kPvalue(hpv.chi$p.value)}.
      \item The null hypothesis is not rejected because the $p-value>\alpha$.
...
@
      \item The table of observed values is shown above in step 4.
      \item The $\chi^{2}$ test statistic is \Sexpr{formatC(tt.chi$statistic,format="f",digits=3)} with \Sexpr{tt.chi$parameter} df, as computed with
<<>>=
tt.chi
@
      \item The p-value for this test statistic is \Sexpr{kPvalue(tt.chi$p.value)}.
      \item The $H_{0}$ is rejected because the p-value $<\alpha$.
...
@
      \item The table of observed values is shown above in step 4.
      \item The $\chi^{2}$ test statistic is \Sexpr{formatC(mvc.chi$statistic,format="f",digits=3)} with \Sexpr{mvc.chi$parameter} df, as computed with
<<>>=
mvc.chi
@
      \item The p-value for this test statistic is \Sexpr{kPvalue(mvc.chi$p.value)}.
      \item The $H_{0}$ is rejected because the p-value $<\alpha$.
...
@
      \item The table of observed values is shown above in step 4.
      \item The $\chi^{2}$ test statistic is \Sexpr{formatC(zoo.chi$statistic,format="f",digits=3)} with \Sexpr{zoo.chi$parameter} df, as computed with
<<>>=
zoo.chi
@
      \item The p-value for this test statistic is \Sexpr{kPvalue(zoo.chi$p.value)}.
      \item The $H_{0}$ is rejected because the p-value $<\alpha$.
