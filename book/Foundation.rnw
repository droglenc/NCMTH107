...
<<KreherParkPbhist, echo=FALSE, fig.cap="Histogram and summary statistics of Pb concentration ($\\mu g \\bullet m^{-3}$) measurements at each of 119 sites in Kreher Park superfund site.">>=
...
<<KreherParkPbhist1, echo=FALSE, fig.scap="Kreher Park 1", fig.cap="Histogram and summary statistics of Pb concentration ($\\mu g \\bullet m^{-3}$) measurements at each of 119 sites (different from the sites shown in \\figref{fig:KreherParkPbhist}) in Kreher Park superfund site.">>=
set.seed(6)
