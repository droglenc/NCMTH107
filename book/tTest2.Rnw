...
\lettrine{T}{he t distribution} and 1-Sample t-Test for comparing the mean of one population to a specific value were introduced in \modref{chap:tTest1}. In this module, a 2-sample t-Test for comparing the means of two populations is introduced.\index{t Test!2-sample}
...
<<Aquapvalue, par1a=TRUE, out.width='.3\\linewidth', fig.cap="Depiction of the p-value in the 2-sample t-Test of BOD measurements in aquaculture example.">>=
