...
@
    ...
    \item A 95\% lower confidence bound is warranted for this situation.  The $t^{*}=$\Sexpr{formatC(qt(0.95,df=49,lower.tail=FALSE),format="f",digits=3)} as computed with
<<fig.show='hide'>>=
