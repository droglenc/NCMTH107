...
<<histOF, echo=FALSE, fig.show='animate', fig.cap='Hisgoram of length (minutes) of eruptions for Old Faitfhul geyser with varying number of classes.', aniopts='controls,palindrome,autoplay'>>=
