...
1. Isolate the following subsets of data (show the structure or a view of the resultant data frame to verify your results).
    1. Only CWD at low-exposure sites.
    1. Only CWD where the diameter was greater than 20 cm.
    1. Only CWD where the diameter was greater than 20 cm and was observed in low-exposure sites.
    1.Only CWD where the diameter was between 20 and 30 cm.
